...
> = {
  ...
  bastet: {
    ...
    narrative: {
      ...
      zh: "巴斯特 (7/14-28, 9/23-27, 10/3-17): 猫女神。你体现了优雅、感性和对所爱之人的 fierce 보호.",
    },
    symbol: "🐱",
  },
  geb: {
    ...
    narrative: {
      ...
      ja: "ゲブ (2/12-29, 8/20-31):大地の神。地に足がついており、信頼でき、物理적인 세계와 연결되어 있습니다.",
  ...
  horus: {
    ...
    narrative: {
      ...
      ja: "ホルス (4/20-5/7, 8/12-19): 天空の隼。鋭い視覚、高潔な勇気、正当한 권리를 되찾을 결단력을 가지고 있습니다.",
  ...
  osiris: {
    ...
    narrative: {
      ...
      ja: "オシリス (3/1-10, 11/27-12/18): 冥界の王. 死と再生の神秘 को 이해합니다.",
