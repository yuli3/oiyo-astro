...
> = {
  byeong: {
    ...
    narrative: {
      ...
      ja: "丙（ヒノエ、陽の火）：燃える太陽。あなたは温もりと存在感、そして生命を与えるエネルギーを放ちます。あなたの存在が周囲のすべてを照らします。",
  ...
  eul: {
    ...
    narrative: {
      ...
      ja: "乙（キノト、陰の木）：柔軟なつる。あなたは適応力と穏やかな粘り強さを体現しています。ツタのように、障害物を優雅に避けながら道を見つけます。",
  ...
  gap: {
    ...
    narrative: {
      ...
      ja: "甲（キノエ、陽の木）：そびえ立つ木。あなたは成長、野心、そして上昇する力を体現しています。大きな樫の木のように、しっかりと立ち、天に向かって伸びていきます。",
  ...
  gi: {
    ...
    narrative: {
      ...
      ja: "己（ツチノト、陰の土）：肥沃な畑。あなたは育成、耕作、そして忍耐強い成長を体現しています。農地のように、あなたに植えられたものを支え、育みます。",
  ...
  gye: {
    ...
    narrative: {
      ...
      ja: "癸（ミズノト、陰の水）：穏やかな雨。あなたは直感、繊細な滋養、そして静かな粘り強さを体現しています。霧のように、見えないところに染み渡り、影響を与えます。",
  ...
  gyeong: {
    ...
    narrative: {
      ...
      ja: "庚（カノエ、陽の金）：鍛えられた剣。あなたは決断力、精密さ、そして鋭い明晰さを体現しています。あなたの存在は正義と鋭い洞察力をもたらします。",
  ...
  im: {
    ...
    narrative: {
      ...
      ja: "壬（ミズノエ、陽の水）：大海。あなたは知恵、深さ、そして順応する力を体現しています。海のように、広大な可能性を秘め、地形さえも変えることができます。",
  ...
  jeong: {
    ...
    narrative: {
      ...
      ja: "丁（ヒノト、陰の火）：ろうそくの炎。あなたは集中した温もりと親密な照らしを体現しています。闇の中の灯火のように、柔らかな光で導きます。",
  ...
  mu: {
    ...
    narrative: {
      ...
      ja: "戊（ツチノエ、陽の土）：大きな山。あなたは安定、信頼性、そして揺るがない存在感を体現しています。他者はあなたの不動の性質に安らぎを見出します。",
  ...
  shin: {
    ...
    narrative: {
      ...
      ja: "辛（カノト、陰の金）：貴重な宝石。あなたは洗練、純粋さ、そして内なる輝きを体現しています。宝石のように、圧力の下でも価値があり美しい存在です。",
...
> = {
  chuk: {
    ...
    narrative: {
      ...
      ja: "丑（ウシ）：忍耐強く勤勉です。あなたはゆっくりでも止まらない前進を体現しています。信頼性と忍耐力があなたの道を定めます。",
  ...
  hae: {
    ...
    narrative: {
      ...
      ja: "亥（イ、イノシシ）：誠実で寛大です。あなたは正直な豊かさと、度を超えることなく人生の喜びを味わう知恵を持っています。",
  ...
  in: {
    ...
    narrative: {
      ...
      ja: "寅（トラ）：勇敢で強力です。あなたは夜明けのエネルギーを宿し、勇気と統率力をもって行動に飛び込む準備ができています。",
  ...
  ja: {
    ...
    narrative: {
      ...
      ja: "子（ネ、ネズミ）：真夜中のエネルギー。機知に富み、才覚があり、戦略的です。あなたは暗闇の中に機会を見出す力を持っています。",
  ...
  jin: {
    ...
    narrative: {
      ...
      ja: "辰（タツ、リュウ）：荘厳で野心的です。あなたは神話と偉大さのエネルギーを宿し、並外れた成就を遂げる運命にあります。",
  ...
  mi: {
    ...
    narrative: {
      ...
      ja: "未（ヒツジ）：創造的で穏やかです。あなたが触れるすべてのものに、芸術的な感性と思いやりのある配慮をもたらします。",
  ...
  myo: {
    ...
    narrative: {
      ...
      ja: "卯（ウ、ウサギ）：穏やかで外交的です。あなたは優雅に世界を渡り歩き、他人が問題に気づく前に解決策を見出します。",
  ...
  o: {
    ...
    narrative: {
      ...
      ja: "午（ウマ）：自由で情熱的です。正午の頂点のエネルギーを体現しています——活力に満ち、活動的で、常に地平線に向かって進み続けます。",
  ...
  sa: {
    ...
    narrative: {
      ...
      ja: "巳（ミ、ヘビ）：賢明で直感的です。あなたは深い知性と、他人が感じ取れないものを察知する力を持っています。",
  ...
  shin_branch: {
    ...
    narrative: {
      ...
      ja: "申（サル）：賢くて多才です。あなたの機敏な頭脳は他人が見逃す解決策を見つけ出し、その適応力には限りがありません。",
  ...
  sul: {
    ...
    narrative: {
      ...
      ja: "戌（イヌ）：忠実で保護的です。あなたは義務、献身、そして愛するものを守る本能を体現しています。",
  ...
  yu: {
    ...
    narrative: {
      ...
      ja: "酉（トリ）：自信があり、観察力に優れています。正確さをもって真実を告げ、他人が見逃す細部に気づきます。",
...
export const GANZHI_COMBINATION_NARRATIVES: Record<string, SixLangString> = {
  "byeong-in": {
    ...
    ja: "丙寅（ひのえ・とら）：太陽の輝きが原初の力と出会う。行動を鼓舞するカリスマ的な力。",
  ...
  "eul-chuk": {
    ...
    ja: "乙丑（きのと・うし）：安定した大地の上での穏やかな粘り強さ。柔軟な適応力が忍耐強い持久力と出会う。",
  ...
  "eul-hae": {
    ...
    ja: "乙亥（きのと・い）：豊かさの中のつる。惜しみない豊穣に育まれた柔軟な成長。",
  ...
  "gap-ja": {
    ...
    ja: "甲子（きのえ・ね）：すべての循環の始まり。強い主導力が機知に富む知性と出会う。無から築き上げるリーダー。",
  ...
  "gap-sul": {
    ...
    ja: "甲戌（きのえ・いぬ）：木の守護者。忠実な献身に守られた成長のエネルギー。",
  ...
  "gi-sa": {
    ...
    ja: "己巳（つちのと・み）：豊かな知恵。忍耐強い耕作に育まれた深い直感。",
  ...
  "gye-yu": {
    ...
    ja: "癸酉（みずのと・とり）：黄昏の雨。直感的な洞察が精密な観察と出会う。",
  ...
  "gyeong-o": {
    ...
    ja: "庚午（かのえ・うま）：陽光の中の剣。決断力ある行動が情熱的な自由と出会う。",
  ...
  "im-shin": {
    ...
    ja: "壬申（みずのえ・さる）：知恵の海。広大な英知が機転の利く多才さと出会う。",
  ...
  "jeong-myo": {
    ...
    ja: "丁卯（ひのと・う）：森の中のろうそくの灯。外交的な温もりと芸術的な感性。",
  ...
  "mu-jin": {
    ...
    ja: "戊辰（つちのえ・たつ）：山が神話と出会う。確固たる現実に根ざした止まることのない野心。",
  ...
  "shin-mi": {
    ...
    ja: "辛未（かのと・ひつじ）：優しい手の中の宝石。洗練された芸術性と思いやりある精密さ。",
