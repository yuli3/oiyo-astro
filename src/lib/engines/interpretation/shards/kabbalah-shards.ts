...
> = {
  binah: {
    narrative: {
      ...
      ja: "ビナー（理解）：偉大な受容的知性。あなたはアイデアに形を与え、深く理解し、概念を現実へと育てる力を持っています。",
  ...
  chesed: {
    narrative: {
      ...
      ja: "ヘセド（慈悲/愛のある親切）：神聖な愛の流出。あなたは寛容さ、拡張、そして無条件の与えることを体現しています。あなたの道は豊かさと恩寵の道です。",
  ...
  chokhmah: {
    narrative: {
      ...
      ja: "ホクマー（知恵）：神聖なインスピレーションの閃き。あなたは創造的可能性の種子を宿し、すべての顕現を始動させる最初のエネルギーの爆発を携えています。",
  ...
  keter: {
    narrative: {
      ...
      ja: "ケテル（王冠）：神聖な意志の最高点。あなたは純粋な意識とすべての創造の源に繋がっています。あなたの人生の目的は超越と霊的な明晰さを含みます。",
  ...
  malkhut: {
    narrative: {
      ...
      ja: "マルクト（王国）：顕現した物質世界。あなたは物理的な現実に根ざし、霊的な知恵を具体的な形と行動へともたらすよう呼ばれています。",
  ...
  tiferet: {
    narrative: {
      ...
      ja: "ティフェレト（美/調和）：生命の樹の心臓部。あなたは対立するものを統合し、均衡の中に美を見出し、慈悲深い真理を体現するよう呼ばれています。",
  ...
  yesod: {
    narrative: {
      ...
      ja: "イェソド（基盤）：世界間のアストラルゲートウェイ。あなたは夢、想像力、そして現実を支える微細なエネルギーと強く結びついています。",
