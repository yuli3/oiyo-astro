...
> = {
  ...
  ansuz: {
    ...
    narrative: {
      ...
      ja: "アンスズ（ᚨ）：オー디ン/神。あなたはコミュニケーションと神聖なインスピレーションの賜物に恵まれています。このルーンはあなたを智恵、詩、そして話된 말의 힘으로 연결합니다.",
  ...
  othala: {
    ...
    narrative: {
      ...
      ja: "オサラ（ᚫ）：相속/遺産。あなたは伝統と帰属のエネルギーを持っています。このルーンは、先祖、物質的な遺産、そして将来の世代のための安定した基盤を表しています。",
  ...
  thurisaz: {
    ...
    narrative: {
      ...
      ja: "ス리사즈（ᚦ）：トール/巨人。あなたは保護と方向付けられた力のエネルギーを持っています。このルーンは障害を打ち砕き、境界を守るハンマーです。",
