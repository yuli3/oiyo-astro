...
> = {
  alder: {
    narrative: {
      ...
      ja: "ハンノキ (フェアン): 戦士の木。挑戦に立ち向かう勇気と、愛するものを守る強さを持っています。",
  ...
  elder: {
    narrative: {
      ...
      ja: "ニワトコ (ルイス): 終わりと再生の木。死と再生のサイクル、完成の知恵を理解しています。",
  ...
  vine: {
    narrative: {
      ...
      ja: "ブドウ (ムイン): 予言と収穫の木。喜びと責任、祝祭と結果のバランスを理解しています。",
