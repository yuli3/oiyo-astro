...
> = {
  cn: MUSIC_TASTE_DESCRIPTIONS_EN,
...
> = {
  cn: MUSIC_TASTE_PREFERRED_GENRES_EN,
...
> = {
  cn: MUSIC_TASTE_ARTIST_SUGGESTIONS_EN,
...
> = {
  cn: MUSIC_TASTE_PERSONALITY_TRAITS_EN,
...
> = {
  cn: MUSIC_TASTE_LISTENING_HABITS_EN,
...
> = {
  cn: MUSIC_TASTE_CONCERT_STYLES_EN,
...
> = {
  cn: MUSIC_TASTE_SOCIAL_STYLES_EN,
...
> = {
  cn: MUSIC_TASTE_MOOD_BOOSTERS_EN,
