...
export const PALM_OUTLINE =
  'M 70 330 ' +
  'C 55 280, 55 230, 60 195 ' +
  'C 50 180, 48 150, 58 140 C 66 132, 76 138, 80 150 ' + // thumb side
  'L 84 120 ' +
  'C 84 95, 90 92, 96 92 C 102 92, 106 96, 106 120 ' + // index
  'L 110 118 C 110 78, 116 75, 122 75 C 128 75, 132 80, 132 118 ' + // middle
  'L 138 120 C 138 84, 144 82, 150 82 C 156 82, 160 88, 160 122 ' + // ring
  'L 166 128 C 168 100, 174 100, 180 102 C 186 104, 188 112, 184 138 ' + // pinky
  'C 200 150, 215 165, 222 200 ' +
  'C 230 245, 222 295, 200 330 ' +
  'Z';
