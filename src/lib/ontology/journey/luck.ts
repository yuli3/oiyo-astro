      ...
      return {
        ...
        tests: {
          ...
          items: [
            ...
            { href: l('/oracle/draw'), emoji: '🔮', label: '오라클 카드 뽑기' },
      ...
      return {
        ...
        tests: {
          ...
          items: [
            ...
            { href: l('/oracle/draw'), emoji: '🔮', label: 'オラクルカード' },
      ...
      return {
        ...
        tests: {
          ...
          items: [
            ...
            { href: l('/oracle/draw'), emoji: '🔮', label: '神谕卡抽取' },
      ...
      return {
        ...
        tests: {
          ...
          items: [
            ...
            { href: l('/oracle/draw'), emoji: '🔮', label: 'Tirage d\'oracle' },
      ...
      return {
        ...
        tests: {
          ...
          items: [
            ...
            { href: l('/oracle/draw'), emoji: '🔮', label: 'Tirada de oráculo' },
      ...
      return {
        ...
        tests: {
          ...
          items: [
            ...
            { href: l('/oracle/draw'), emoji: '🔮', label: 'Oracle card draw' },
