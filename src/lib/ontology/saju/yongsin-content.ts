...
export const YONGSIN_C = {
  ...
  strengthDesc: {
    strong: { ko: "일간을 돕는 기운이 넉넉합니다. 에너지를 밖으로 풀어내는 오행이 이롭습니다.", en: "Plenty of energy supports your Day Master. Elements that release that energy outward help you.", ja: "日干を助ける気が十分にあります。そのエネルギーを外へ放つ五行が有利です。", zh: "扶助日干的能量充足。能把这股能量向外释放的五行对你有利。", fr: "Votre Maître du jour reçoit beaucoup de soutien. Les éléments qui libèrent cette énergie vers l'extérieur vous aident.", es: "Tu Maestro del Día recibe bastante apoyo. Te ayudan los elementos que liberan esa energía hacia afuera." } as L<string>,
...
export const CATEGORIES_C = {
  ...
  wealth: {
    ...
    guide: {
      favorable: { ko: "일을 하면 숫자가 따라오는 날이 이미 있었을 겁니다. 재성이 용신 쪽에 있어, 손이 움직이는 만큼 들어오는 구조입니다. 과하면 숫자만 보고 사람을 놓칩니다. 이번 달에 '남는 돈'이 어디로 가는지만 한 줄 적어 보면 됩니다.", en: "You have probably already seen work turn into numbers. Wealth sits with your helpful element, so motion converts. Excess is counting people as a column. Write one line this month: where the leftover actually goes.", ja: "財星が用神と調和し、努力が財につながりやすい配置です。実のある投資や管理に強みがあります。", zh: "财星与用神相合，努力容易转化为财富。你在务实投资与管理上有优势。", fr: "La Richesse s'accorde avec votre élément favorable, donc l'effort se convertit bien en argent. Vous avez des forces en gestion et en investissement concrets.", es: "La Riqueza se alinea con tu elemento favorable, por eso el esfuerzo se convierte bien en dinero. Tienes fortaleza para invertir y gestionar con sentido práctico." } as L<string>,
      unfavorable: { ko: "벌자는 마음은 빠른데, 몸이 그 속도를 못 따라가는 배치입니다. 재물이 용신을 흔들면 확장이 숨이 됩니다. 과하면 한 건이 전부를 담보합니다. '지금 안 해도 무너지지 않는 일'이 뭔지만 가려 보십시오.", en: "The will to earn runs ahead of the body. When wealth rattles the helpful element, expansion becomes breath. Excess is one deal holding everything. Name what would not collapse if you did not do it this week.", ja: "財への欲がバランスを揺らしやすいです。無理な拡大より、身の丈に合った管理が有利です。", zh: "对财富的欲望可能扰乱平衡。与其过度扩张，不如按自身条件稳健管理。", fr: "La poursuite de l'argent peut vous déséquilibrer. Une gestion régulière vaut mieux qu'une expansion excessive.", es: "Perseguir el dinero puede desequilibrarte. Una gestión constante supera el exceso de ambición." } as L<string>,
      neutral: { ko: "큰 한 방이 안 오는 게 아닙니다. 반복이 안 만들어져 있는 겁니다. 재성은 여기선 월급날의 습관에 가깝습니다. 과하면 기다림을 게으름으로 오해합니다. 매주 같은 시간에 같은 통장만 열어 보면 됩니다.", en: "The missing piece is not a jackpot. It is a repeatable Tuesday. Wealth here is a payday habit. Excess is calling waiting laziness. Open the same account at the same hour once a week.", ja: "財は継続によって積み上がる構造です。一発逆転より、繰り返せる流れを作りましょう。", zh: "财富属于靠持续积累的结构。与其追求一次爆发，不如打造可重复的流动。", fr: "La richesse se construit par la constance. Privilégiez des flux répétables plutôt qu'un grand coup.", es: "La riqueza se construye con constancia. Prioriza flujos repetibles antes que un gran golpe de suerte." } as L<string>,
    },
  ...
  career: {
    ...
    intro: { ko: "직업 성향은 가장 두드러진 십성으로 봅니다.", en: "Career style is read from your most prominent ten-god.", ja: "職業傾向は、最も目立つ十星から読みます。", zh: "职业倾向通过最突出的十神来看。", fr: "Le style de carrière se lit à partir du dix-dieu le plus marqué.", es: "El estilo profesional se interpreta a partir del diez-dios más destacado." } as L<string>,
    mode: {
      official: { ko: "관성이 크게 울립니다. 누가 맡겼는지가 분명할 때 숨이 덜 막힙니다. 과하면 직함이 내가 됩니다. '이 역할 없이 내가 뭘 지키나'만 적어 가면 됩니다.", en: "Authority is loud. Breath comes easier when the brief is named. Excess is becoming the title. Write: what do I keep if this role is gone?", ja: "官星が優勢 — 組織・専門職・公職のように秩序と責任が明確な道が合います。", zh: "官星占优 — 适合组织、专业岗位、公职等秩序与责任明确的道路。", fr: "Dominante Autorité : les organisations, professions et fonctions publiques avec un ordre clair vous conviennent.", es: "Dominio de Autoridad: te convienen organizaciones, profesiones y roles públicos con orden claro." } as L<string>,
      creative: { ko: "식상이 크게 울립니다. 만들어 내놓아야 일이 끝난 느낌이 납니다. 과하면 발표만 하고 수습은 남에게 맡깁니다. 이번 주에 '보낸 것' 하나를 끝까지 거두었는지 보면 됩니다.", en: "Output is loud. Work feels finished only when something left the desk. Excess is announcing and leaving the mess. Check whether one thing you sent this week was actually closed.", ja: "食傷が優勢 — 創作・表現・起業のように成果物を外へ出す道が合います。", zh: "食伤占优 — 适合创作、表达、创业等把成果展示出来的道路。", fr: "Dominante Production : les voies créatives, expressives et entrepreneuriales qui livrent un résultat vous conviennent.", es: "Dominio de Producción: te convienen caminos creativos, expresivos y emprendedores que muestran resultados." } as L<string>,
      academic: { ko: "인성이 크게 울립니다. 배우고 쌓는 시간이 일을 버티게 합니다. 과하면 자격만 모으고 현장은 미룹니다. '이걸 어디에 쓰려고 배우나' 한 줄이면 됩니다.", en: "Resource is loud. Study is what lets the job hold. Excess is stacking credentials and postponing the floor. One line: what is this for?", ja: "印星が優勢 — 学問・研究・資格のように学び積み上げる道が合います。", zh: "印星占优 — 适合学术、研究、资格认证等学习并积累的道路。", fr: "Dominante Ressource : les voies académiques, de recherche et de certification qui accumulent le savoir vous conviennent.", es: "Dominio de Recurso: te convienen caminos académicos, de investigación y credenciales que acumulan conocimiento." } as L<string>,
      peer: { ko: "비겁이 크게 울립니다. 같은 편과 나란히 있을 때 속도가 납니다. 과하면 내 몫과 우리 몫이 섞입니다. 이번 협력에서 내 이름이 붙는 일이 뭔지만 밝히면 됩니다.", en: "Peer is loud. Pace appears beside equals. Excess is mixing my share with ours. Name the piece that still has your name on it.", ja: "比劫が優勢 — 共同事業・専門家ネットワークのように仲間と共に進む道が合います。", zh: "比劫占优 — 适合合伙、专家网络等与同伴并肩前行的道路。", fr: "Dominante Pair : les partenariats et réseaux d'experts où vous travaillez avec des égaux vous conviennent.", es: "Dominio de Par: te convienen asociaciones y redes de expertos donde trabajas junto a iguales." } as L<string>,
    },
  ...
  love: {
    ...
    guide: {
      favorable: { ko: "곁에 있으면 일이 가벼워지는 사람이 이미 있을 겁니다. 배우자성이 용신과 같아, 관계가 짐이 아니라 숨입니다. 과하면 솔직함이 상대를 심문합니다. 이번 주에 먼저 말한 쪽은 누구였는지면 됩니다.", en: "Someone already makes the work lighter. The spouse star sits with the helpful element, so the bond is breath, not freight. Excess is honesty as interrogation. Notice who spoke first this week.", ja: "縁の気が用神と調和し、関係が力になります。率直さがよい縁を引き寄せます。", zh: "缘分之气与用神相合，关系会成为力量。真诚会带来好的缘分。", fr: "Votre énergie relationnelle s'accorde avec votre élément favorable ; les liens vous renforcent. La sincérité attire de bonnes relations.", es: "Tu energía de relación se alinea con tu elemento favorable; los vínculos te fortalecen. La sinceridad atrae buenas conexiones." } as L<string>,
      unfavorable: { ko: "기대를 먼저 올려 놓고 사람을 맞추는 버릇이 여기 있습니다. 관계가 용신을 밀치면 속도가 싸움이 됩니다. 과하면 침묵이 벌입니다. '지금 원하는 속도'를 한 번만 말로 하면 됩니다.", en: "The habit is raising the bar, then fitting the person to it. When the bond shoves the helpful element, pace becomes a fight. Excess is silence as a fine. Say the speed you actually want, once.", ja: "関係の中でバランスが揺れやすいです。期待を下げ、歩調を合わせると安定します。", zh: "关系中的平衡容易摇晃。降低期待并配合节奏，会更稳定。", fr: "L'équilibre peut vaciller dans les relations. Abaissez les attentes et ajustez le rythme pour le stabiliser.", es: "El equilibrio puede tambalearse en las relaciones. Baja expectativas y acompasa el ritmo para estabilizarlo." } as L<string>,
  ...
  health: {
    ...
    imbalance: {
      excess: { ko: "한 기운이 방을 다 씁니다. 그 오행이 가리키는 장부를 '병'으로 읽지 마십시오. 다만 그 계통이 과로하기 쉽다는 힌트입니다. 의학이 아닙니다. 잠·식사·숨이 어디서 끊기는지만 보면 됩니다.", en: "One element is taking the whole room. That is not a diagnosis of the organ it names. It is a hint that system overworks. Not medicine. Watch where sleep, food, or breath actually breaks.", ja: "特定の五行が過剰です。その気が向かう臓腑に負担がかからないよう、バランスを見直しましょう。", zh: "某个五行过旺。请注意重新平衡，避免其对应的脏腑系统过度受压。", fr: "Un élément est excessif. Rééquilibrez pour éviter de surcharger le système organique associé.", es: "Un elemento está en exceso. Reequilibra para evitar sobrecargar su sistema orgánico asociado." } as L<string>,
