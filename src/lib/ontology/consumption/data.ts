...
> = {
  emotional_satisfaction: {
    description: {
      cn: "比起拥有，更看重物品带来的情绪体验和安慰。消费是你的治愈仪式。",
  ...
  impulsive: {
    description: {
      cn: "根据此刻的吸引力和直觉果断决定。你的生活充满了多彩的体验。",
  ...
  prestige_seeking: {
    description: {
      cn: "高度评价作为表现手段的消费价值。你的物品体现了你的地位。",
