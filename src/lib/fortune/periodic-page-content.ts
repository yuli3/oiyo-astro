    ...
    const copy: Record<Locale, PageCopy> = {
      ko: {
        ...
        related: [
          ...
          { href: 'https://wiki.oiyo.net/ko/meaning-of-palja/', label: '팔자 정의', desc: '사주팔자의 구조를 wiki에서 읽습니다.' },
        ],
      ...
      en: {
        ...
        related: [
          ...
          { href: 'https://wiki.oiyo.net/en/meaning-of-palja/', label: 'Meaning of Palja', desc: 'Read the Four Pillars definition on wiki.' },
        ],
      ...
      ja: {
        ...
        related: [
          ...
          { href: 'https://wiki.oiyo.net/ja/meaning-of-palja/', label: '四柱八字とは', desc: '四柱の構造をwikiで読みます。' },
        ],
      ...
      zh: {
        ...
        related: [
          ...
          { href: 'https://wiki.oiyo.net/zh/meaning-of-palja/', label: '八字含义', desc: '在 wiki 阅读四柱结构。' },
        ],
      ...
      fr: {
        ...
        related: [
          ...
          { href: 'https://wiki.oiyo.net/fr/meaning-of-palja/', label: 'Signification de Palja', desc: 'Lire la définition sur wiki.' },
        ],
      ...
      es: {
        ...
        related: [
          ...
          { href: 'https://wiki.oiyo.net/es/meaning-of-palja/', label: 'Significado de Palja', desc: 'Lee la definición en wiki.' },
        ],
  ...
  const copy: Record<Locale, PageCopy> = {
    ko: {
      ...
      related: [
        ...
        { href: 'https://wiki.oiyo.net/ko/meaning-of-astrology/', label: '점성술 정의', desc: '별자리와 점성술의 기본을 읽습니다.' },
      ],
    ...
    en: {
      ...
      related: [
        ...
        { href: `/${locale}/fortune/${period}/`, label: 'Combined fortune', desc: 'Compare Saju, Chinese zodiac, and star sign together.' },
        { href: 'https://wiki.oiyo.net/en/meaning-of-astrology/', label: 'Meaning of Astrology', desc: 'Read the basics of zodiac and astrology.' },
      ],
    ...
    ja: {
      ...
      related: [
        ...
        { href: `/${locale}/fortune/${period}/`, label: '総合運勢', desc: '四柱・十二支・星座を比較します。' },
        { href: 'https://wiki.oiyo.net/ja/meaning-of-astrology/', label: '占星術とは', desc: '星座と占星術の基本を読みます。' },
      ],
    ...
    zh: {
      ...
      related: [
        ...
        { href: `/${locale}/fortune/${period}/`, label: '综合运势', desc: '比较四柱、生肖和星座。' },
        { href: 'https://wiki.oiyo.net/zh/meaning-of-astrology/', label: '占星含义', desc: '阅读星座和占星基础。' },
      ],
    ...
    fr: {
      ...
      related: [
        ...
        { href: `/${locale}/fortune/${period}/`, label: 'Fortune combinée', desc: 'Comparer Saju, zodiaque chinois et signe astral.' },
        { href: 'https://wiki.oiyo.net/fr/meaning-of-astrology/', label: 'Signification de l’astrologie', desc: 'Lire les bases du zodiaque et de l’astrologie.' },
      ],
    ...
    es: {
      ...
      related: [
        ...
        { href: `/${locale}/fortune/${period}/`, label: 'Fortuna combinada', desc: 'Compara Saju, zodiaco chino y signo.' },
        { href: 'https://wiki.oiyo.net/es/meaning-of-astrology/', label: 'Significado de la astrología', desc: 'Lee bases del zodiaco y astrología.' },
      ],
