...
- Perfeccionismo paralizante: Significado de perfeccionismo paralizante
- Indefensión aprendida (Learned Helplessness): Significado de indefensión aprendida
- Carga cognitiva (Cognitive Load): [Significado de carga cognitiva](https://oiyo.net/ko/cognitive-load/about/)
- Fatiga de decisión (Decision Fatigue): Significado de fatiga de decisión
- Bucle de dopamina (Dopamine Loop): Significado de bucle de dopamina
