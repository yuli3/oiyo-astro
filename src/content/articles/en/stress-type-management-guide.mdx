...
If you want to start with a quick check, use the [burnout self-assessment](/en/burnout/test/). If your stress pattern seems strongly tied to personality, use the MBTI stress type test.
