...
// tests/index.astro 와 test-directory-extra.ts 가 정본이며 여기서 복제하지 않는다 — 복제하면 두
...
export const LANE_BY_PATH: Record<string, LaneId> = {
  ...
  // 추가 디렉터리도 같은 질문 분류를 따른다. 대표 목록 뒤에 펼쳐 본다.
  "/animal-personality-test": "self",
  "/coffee-personality-test": "self",
  "/cognitive-bias-test": "self",
  "/color-personality-test": "self",
  "/creativity-type-test": "self",
  "/disc-personality-test": "self",
  "/egogram-test": "self",
  "/emotional-mind-test": "self",
  "/gratitude-style-test": "self",
  "/growth-mindset-test": "self",
  "/hsp-test": "self",
  "/introvert-extrovert-test": "self",
  "/learning-style-test": "self",
  "/optimism-test": "self",
  "/perfume-personality-test": "self",
  "/sensory-processing-test": "self",
  "/social-media-personality-test": "self",
  "/strengths-discovery-test": "self",
  "/thinking-patterns-test": "self",
  "/value-compass-test": "self",
  "/country/match": "self",
  "/boundary-style-test": "relationships",
  "/breakup-recovery-test": "relationships",
  "/codependency-test": "relationships",
  "/communication-style-test": "relationships",
  ...
  "/parenting-style-test": "relationships",
  "/personal-boundaries-test": "relationships",
  "/tone-analysis-test": "relationships",
  "/toxic-relationship-test": "relationships",
  "/trust-style-test": "relationships",
  "/business-type-test": "work",
  "/collab-risk-test": "work",
  "/critical-thinking-test": "work",
  "/decision-making-test": "work",
  "/focus-blocker-test": "work",
  "/grit-scale-test": "work",
  "/imposter-syndrome-test": "work",
  "/leadership-style-test": "work",
  "/money-personality-test": "work",
  "/motivation-type-test": "work",
  ...
  "/work-style-test": "work",
  "/coping-style-test": "mood",
  "/digital-balance-test": "mood",
  "/digital-wellness-test": "mood",
  "/dopamine-dependency-test": "mood",
  "/emotion-diary": "mood",
  "/emotion-regulation-test": "mood",
  "/emotional-eating-test": "mood",
  "/fear-type-test": "mood",
  "/happiness-meter-test": "mood",
  "/health-anxiety-test": "mood",
  ...
  "/stress-type-test": "mood",
  "/stress-events/test": "mood",

};

/** "지금 마음"은 선별 도구 묶음이라 묶음 단위 비진단 경계가 필요하다. */
export const MOOD_BOUNDARY: Record<Locale, string> = {
  ko: "자가 점검을 위한 도구이며 진단이 아닙니다. 결과가 걱정되면 전문가와 상의하세요.",
  en: "These tools are for self-reflection, not diagnosis. If a result worries you, talk to a professional.",
  ja: "自己点検のためのツールであり、診断ではありません。結果が気になる場合は専門家にご相談ください。",
  zh: "这些工具用于自我检查，不用于诊断。若结果令你担心，请咨询专业人士。",
  fr: "Ces outils servent à faire le point, pas à poser un diagnostic. Si un résultat vous inquiète, consultez un professionnel.",
  es: "Son herramientas de reflexión personal, no de diagnóstico. Si un resultado te preocupa, consulta a un profesional.",
};

/** 네 질문에 맞지 않는 항목. URL을 없애지 않고 전역 검색에서 유지한다. */
export const SEARCH_ONLY_PATHS: Record<string, string> = {
  "/biological-age-test": "건강 나이 계산기",
  "/chimp-test": "기억력 게임",
  "/color-memory-test": "기억력 게임",
  "/color-recognition-test": "색채 지각 게임",
  "/english-level-test": "영어 능력 측정",
  "/information-hygiene": "정보 검토 도구",
  "/spatial-iq-game": "공간 지각 게임",
  "/typing-speed-test": "타자 도구",
  "/typing-test": "타자 도구",
  "/habit-builder/guide": "설명 글",
  "/mbti/habits": "습관 해설",
  "/reincarnation-country": "인구 가중 무작위 추첨",
  "/color-aura-test": "상징 해석",
  "/hormones-test": "생물학적 성격 해석",
  "/leftbrain-test": "좌뇌·우뇌 유형 해석",
};
