...
const ALMANAC_IMPORTS: Record<string, AlmanacImporter> = {
  "zh/april": () => import("../messages/zh/april.json"),
  "zh/august": () => import("../messages/zh/august.json"),
  "zh/december": () => import("../messages/zh/december.json"),
  "zh/february": () => import("../messages/zh/february.json"),
  "zh/january": () => import("../messages/zh/january.json"),
  "zh/july": () => import("../messages/zh/july.json"),
  "zh/june": () => import("../messages/zh/june.json"),
  "zh/march": () => import("../messages/zh/march.json"),
  "zh/may": () => import("../messages/zh/may.json"),
  "zh/november": () => import("../messages/zh/november.json"),
  "zh/october": () => import("../messages/zh/october.json"),
  "zh/september": () => import("../messages/zh/september.json"),
