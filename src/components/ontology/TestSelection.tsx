          ...
          >
            ...
            <div className="relative h-full flex flex-col">
              ...
              <CardFooter className="p-6 pt-0 mt-auto">
                <SmartLink
                  className="flex items-center justify-between w-full p-4 bg-green-600 text-primary-foreground hover:bg-primary rounded-2xl text-[11px] font-black uppercase tracking-[0.2em] transition-all group/btn shadow-lg shadow-green-600/20 border-none"
