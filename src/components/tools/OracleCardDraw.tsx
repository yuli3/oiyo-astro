...
const DECK: OracleCard[] = [
  {
    id: 1, glyph: '✦',
    title: { ko: '탁월함', en: 'Excellence', ja: '卓越', zh: '卓越', fr: 'Excellence', es: 'Excelencia' },
    wisdom: {
      ...
      zh: '在一切都达到极致的世界里，平庸不再是选项。同时磨砺品格与智慧。',
  ...
  {
    id: 2, glyph: '⬡',
    title: { ko: '강직함', en: 'Integrity', ja: '剛直', zh: '刚直', fr: 'Intégrité', es: 'Integridad' },
    wisdom: {
      ...
      zh: '刚直的人即使无利可图、不受欢迎，也坚守自己的原则。这是信任的根基。',
  ...
  {
    id: 3, glyph: '◯',
    title: { ko: '침묵의 힘', en: 'Power of Silence', ja: '沈黙の力', zh: '沉默之力', fr: 'Pouvoir du Silence', es: 'Poder del Silencio' },
    wisdom: {
  ...
  {
    id: 4, glyph: '◈',
    title: { ko: '신중함', en: 'Prudence', ja: '慎重', zh: '谨慎', fr: 'Prudence', es: 'Prudencia' },
    wisdom: {
      ...
      zh: '行动前三思而后行。谨慎不是勇气的对立面，而是让勇气更持久的方法。',
  ...
  {
    id: 5, glyph: '⌛',
    title: { ko: '때를 아는 지혜', en: 'Knowing the Moment', ja: '時を知る知恵', zh: '识时务', fr: 'Sagesse du Moment', es: 'Sabiduría del Momento' },
    wisdom: {
      ...
      zh: '即使最优秀的行动，在错误的时机也会失败。知道何时等待是最难的技艺。',
  ...
  {
    id: 6, glyph: '☽',
    title: { ko: '자기 이해', en: 'Self-Knowledge', ja: '自己理解', zh: '自知', fr: 'Connaissance de Soi', es: 'Autoconocimiento' },
    wisdom: {
      ...
      zh: '了解自己优势与弱点的人永不误判自己。自知是所有智慧的开始。',
  ...
  {
    id: 7, glyph: '◇',
    title: { ko: '평판의 관리', en: 'Reputation', ja: '評判の管理', zh: '声誉管理', fr: 'Gestion de la Réputation', es: 'Gestión de la Reputación' },
    wisdom: {
      ...
      zh: '建立声誉需要一生，失去只需一瞬。但不要畏惧声誉，而要用它来获得自由。',
  ...
  {
    id: 8, glyph: '∞',
    title: { ko: '인내', en: 'Endurance', ja: '忍耐', zh: '忍耐', fr: 'Endurance', es: 'Perseverancia' },
    wisdom: {
      ...
      zh: '忍耐征服时间。急于不必急的事是最大的浪费。等待也是行动。',
  ...
  {
    id: 9, glyph: '⌾',
    title: { ko: '단순함', en: 'Simplicity', ja: '単純さ', zh: '简单', fr: 'Simplicité', es: 'Simplicidad' },
    wisdom: {
      ...
      zh: '复杂往往是无知的另一个名字。真正理解的事情可以简单解释。简单是精通的标志。',
  ...
  {
    id: 10, glyph: '◉',
    title: { ko: '사람을 아는 법', en: 'Knowing People', ja: '人を知る法', zh: '识人之道', fr: 'Connaitre les Gens', es: 'Conocer a las Personas' },
    wisdom: {
      ...
      zh: '以行为而非言语判断人。话语是包装，行动才是真相。危机时刻才能看出真正的人。',
  ...
  {
    id: 11, glyph: '⟁',
    title: { ko: '역경의 의미', en: 'Meaning in Adversity', ja: '逆境の意味', zh: '逆境之意', fr: 'Sens dans l\'Adversité', es: 'Significado en la Adversidad' },
    wisdom: {
      ...
      zh: '逆境是显示人真正价值的试金石。在顺境中展现的能力是平凡的，但克服困难的能力是伟大的。',
  ...
  {
    id: 12, glyph: '⬢',
    title: { ko: '감정의 통제', en: 'Mastering Emotions', ja: '感情の統制', zh: '情绪掌控', fr: 'Maîtrise des Émotions', es: 'Control de Emociones' },
    wisdom: {
      ...
      zh: '掌控情绪者掌控局势。愤怒是毒药，冷静是武器。最强的人不是隐藏情感的人，而是驾驭情感的人。',
  ...
  {
    id: 13, glyph: '⊕',
    title: { ko: '선택의 기술', en: 'Art of Choice', ja: '選択の技術', zh: '选择之道', fr: 'Art du Choix', es: 'Arte de Elegir' },
    wisdom: {
      ...
      zh: '生命是一系列的选择。好的选择来自深思熟虑，差的选择来自一时冲动。放弃也是一种选择。',
  ...
  {
    id: 14, glyph: '⟐',
    title: { ko: '관계의 지혜', en: 'Wisdom in Bonds', ja: '人間関係の知恵', zh: '关系之道', fr: 'Sagesse des Liens', es: 'Sabiduría en Vínculos' },
    wisdom: {
      ...
      zh: '好的关系不在于给予和索取，而在于激发彼此的最佳状态。周围的人塑造了你。',
  ...
  {
    id: 15, glyph: '⟲',
    title: { ko: '변화', en: 'Transformation', ja: '変容', zh: '变化', fr: 'Transformation', es: 'Transformación' },
    wisdom: {
      ...
      zh: '惧怕变化的人无法成长。但智慧在于辨别什么必须改变，什么必须保留。',
  ...
  {
    id: 16, glyph: '⌂',
    title: { ko: '내면의 질서', en: 'Inner Order', ja: '内なる秩序', zh: '内在秩序', fr: 'Ordre Intérieur', es: 'Orden Interior' },
    wisdom: {
      ...
      zh: '要控制外部世界，首先建立内在秩序。内心混乱的人怨天尤人，内心有序的人创造环境。',
  ...
  {
    id: 17, glyph: '✧',
    title: { ko: '말의 힘', en: 'Power of Words', ja: '言葉の力', zh: '言语之力', fr: 'Pouvoir des Mots', es: 'Poder de las Palabras' },
    wisdom: {
      ...
      zh: '语言既是矛也是盾。话语可以成就一个人，也可以摧毁一个人。说出的话无法收回。',
  ...
  {
    id: 18, glyph: '⊿',
    title: { ko: '미래를 위한 준비', en: 'Preparing for Tomorrow', ja: '明日への準備', zh: '为未来做准备', fr: 'Se Préparer pour Demain', es: 'Prepararse para el Mañana' },
    wisdom: {
      ...
      zh: '今天的准备创造明天的机会。成功的人并不是运气好，只是机会来临时他们已经做好了准备。',
  ...
  {
    id: 19, glyph: '☀',
    title: { ko: '승리의 품격', en: 'Grace in Victory', ja: '勝利の品格', zh: '胜利之格', fr: 'Grâce dans la Victoire', es: 'Gracia en la Victoria' },
    wisdom: {
      ...
      zh: '不要试图彻底击垮对手。即使是失败者也应保留尊严。慷慨创造持久的胜利。',
  ...
  {
    id: 20, glyph: '⚡',
    title: { ko: '진정한 용기', en: 'True Courage', ja: '真の勇気', zh: '真正的勇气', fr: 'Vrai Courage', es: 'Verdadero Valor' },
    wisdom: {
      ...
      zh: '勇气不是没有恐惧。在感到害怕的同时做正确的事——那才是真正的勇气。懦夫和英雄感受着同样的恐惧。',
  ...
  {
    id: 21, glyph: '⊚',
    title: { ko: '조화', en: 'Harmony', ja: '調和', zh: '和谐', fr: 'Harmonie', es: 'Armonía' },
    wisdom: {
      ...
      zh: '极端总是危险的。太多或太少都会产生问题。智慧存在于和谐之中，美存在于平衡之中。',
  ...
  {
    id: 22, glyph: '⟳',
    title: { ko: '귀환', en: 'Return', ja: '帰還', zh: '回归', fr: 'Retour', es: 'Regreso' },
    wisdom: {
      ...
      zh: '每一段伟大的旅程都回到起点。但你不是回到同一个地方——而是以一个视野更宽广的人的身份回来。',
...
const SPREADS: Record<SpreadKey, { roles: Record<L, string[]>; label: Record<L, string> }> = {
  single: {
    label: { ko: '한 장 뽑기', en: 'One Card', ja: '一枚引き', zh: '单张', fr: 'Une Carte', es: 'Una Carta' },
    roles: {
      ko: ['지금 이 순간'], en: ['This Moment'], ja: ['今この瞬間'],
      zh: ['此刻'], fr: ['Ce Moment'], es: ['Este Momento'],
    },
  },
  'past-present-future': {
    label: { ko: '과거·현재·미래', en: 'Past · Present · Future', ja: '過去·現在·未来', zh: '过去·现在·未来', fr: 'Passé · Présent · Futur', es: 'Pasado · Presente · Futuro' },
    roles: {
      ko: ['과거', '현재', '미래'], en: ['Past', 'Present', 'Future'], ja: ['過去', '現在', '未来'],
      zh: ['过去', '现在', '未来'], fr: ['Passé', 'Présent', 'Futur'], es: ['Pasado', 'Presente', 'Futuro'],
    },
  },
  'body-mind-spirit': {
    label: { ko: '몸·마음·정신', en: 'Body · Mind · Spirit', ja: '体·心·精神', zh: '身·心·灵', fr: 'Corps · Esprit · Âme', es: 'Cuerpo · Mente · Espíritu' },
    roles: {
      ko: ['몸', '마음', '정신'], en: ['Body', 'Mind', 'Spirit'], ja: ['体', '心', '精神'],
      zh: ['身', '心', '灵'], fr: ['Corps', 'Esprit', 'Âme'], es: ['Cuerpo', 'Mente', 'Espíritu'],
    },
  },
}
