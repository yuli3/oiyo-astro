...
export const ZODIACS: Record<ZodiacAnimal, ZodiacData> = {
  rat: {
    ...
    name: { ko: "쥐", en: "Rat", ja: "子(ネズミ)", fr: "Rat", es: "Rata", cn: "鼠", zh: "鼠" },
    traits: {
      ...
      cn: ["聰明", "適應力強", "社交性好", "機會主義", "勤奮"],
      zh: ["聪明", "适应力强", "社交性好", "机会主义", "勤奋"],
    },
    strengths: {
      ...
      cn: ["判斷力敏銳", "人際關係出色", "善用資源"],
      zh: ["判断力敏锐", "人际关系出色", "善用资源"],
    },
    weaknesses: {
    ...
    career: {
      ...
      cn: "在商業、金融、寫作、藝術和政治領域表現出色。",
      zh: "在商业、金融、写作、艺术和政治领域表现出色。",
    },
    love: {
      ...
      cn: "與龍年和猴年最佳。坦誠表達情感可建立更深厚的關係。",
      zh: "与龙年和猴年最佳。坦诚表达情感可建立更深厚的关系。",
    },
  ...
  ox: {
    ...
    name: { ko: "소", en: "Ox", ja: "丑(ウシ)", fr: "Bœuf", es: "Buey", cn: "牛", zh: "牛" },
    traits: {
    ...
    strengths: {
      ...
      cn: ["責任心強", "耐力卓越", "領導力值得信賴"],
      zh: ["责任心强", "耐力卓越", "领导力值得信赖"],
    },
    weaknesses: {
    ...
    career: {
      ...
      cn: "適合農業、醫學、製造業、藝術和政治領域。",
      zh: "适合农业、医学、制造业、艺术和政治领域。",
    },
    love: {
      ...
      cn: "與鼠年、蛇年、雞年建立穩定關係。增加情感表達可加深關係。",
      zh: "与鼠年、蛇年、鸡年建立稳定关系。增加情感表达可加深关系。",
    },
  ...
  tiger: {
    ...
    name: { ko: "호랑이", en: "Tiger", ja: "寅(トラ)", fr: "Tigre", es: "Tigre", cn: "虎", zh: "虎" },
    traits: {
    ...
    career: {
      ...
      cn: "在軍人、消防員、探險家、管理者和廣告領域表現出色。",
      zh: "在军人、消防员、探险家、管理者和广告领域表现出色。",
    },
    love: {
      ...
      cn: "與馬年和狗年有如火焰般的相容。給予對方自由的戀愛最為理想。",
      zh: "与马年和狗年有如火焰般的相容。给予对方自由的恋爱最为理想。",
    },
  ...
  rabbit: {
    ...
    name: { ko: "토끼", en: "Rabbit", ja: "卯(ウサギ)", fr: "Lapin", es: "Conejo", cn: "兔", zh: "兔" },
    traits: {
    ...
    strengths: {
      ...
      cn: ["同理心出色", "審美感細膩", "化解衝突能力強"],
      zh: ["同理心出色", "审美感细腻", "化解冲突能力强"],
    },
    weaknesses: {
    ...
    career: {
      ...
      cn: "適合外交官、藝術家、教師、醫生和行政管理人員。",
      zh: "适合外交官、艺术家、教师、医生和行政管理人员。",
    },
    love: {
      ...
      cn: "與羊年和豬年保持溫暖舒適的關係。在穩定的環境中愛情得以綻放。",
      zh: "与羊年和猪年保持温暖舒适的关系。在稳定的环境中爱情得以绽放。",
    },
  ...
  dragon: {
    ...
    name: { ko: "용", en: "Dragon", ja: "辰(タツ)", fr: "Dragon", es: "Dragón", cn: "龍", zh: "龙" },
    traits: {
      ...
      cn: ["自信", "有魅力", "有野心", "完美主義", "獨創性強"],
      zh: ["自信", "有魅力", "有野心", "完美主义", "独创性强"],
    },
    strengths: {
    ...
    career: {
      ...
      cn: "作為CEO、政治家、藝術家、建築師和醫生，成功可能性高。",
      zh: "作为CEO、政治家、艺术家、建筑师和医生，成功可能性高。",
    },
    love: {
      ...
      cn: "與鼠年和猴年有強烈的化學反應。給予伴侶足夠空間至關重要。",
      zh: "与鼠年和猴年有强烈的化学反应。给予伴侣足够空间至关重要。",
    },
  ...
  snake: {
    ...
    name: { ko: "뱀", en: "Snake", ja: "巳(ヘビ)", fr: "Serpent", es: "Serpiente", cn: "蛇", zh: "蛇" },
    traits: {
      ...
      cn: ["直覺力強", "神秘", "智慧", "獨立", "洞察力強"],
      zh: ["直觉力强", "神秘", "智慧", "独立", "洞察力强"],
    },
    strengths: {
    ...
    career: {
      ...
      cn: "適合科學家、分析師、心理學家、教授和占星師。",
      zh: "适合科学家、分析师、心理学家、教授和占星师。",
    },
    love: {
      ...
      cn: "與牛年和雞年建立深厚可信的關係。坦誠溝通是關係的核心。",
      zh: "与牛年和鸡年建立深厚可信的关系。坦诚沟通是关系的核心。",
    },
  ...
  horse: {
    ...
    name: { ko: "말", en: "Horse", ja: "午(ウマ)", fr: "Cheval", es: "Caballo", cn: "馬", zh: "马" },
    traits: {
    ...
    strengths: {
      ...
      cn: ["說服力強", "社交能力出色", "解決問題能力強"],
      zh: ["说服力强", "社交能力出色", "解决问题能力强"],
    },
    weaknesses: {
    ...
    career: {
      ...
      cn: "適合旅行者、作家、譯員、運動員和記者。",
      zh: "适合旅行者、作家、译员、运动员和记者。",
    },
    love: {
      ...
      cn: "與虎年、羊年和狗年熱情相容。允許自由的伴侶最為理想。",
      zh: "与虎年、羊年和狗年热情相容。允许自由的伴侣最为理想。",
    },
  ...
  goat: {
    ...
    name: { ko: "양", en: "Goat", ja: "未(ヒツジ)", fr: "Chèvre", es: "Cabra", cn: "羊", zh: "羊" },
    traits: {
      ...
      cn: ["有創意", "溫和", "有同理心", "優柔寡斷", "有藝術感"],
      zh: ["有创意", "温和", "有同理心", "优柔寡断", "有艺术感"],
    },
    strengths: {
      ...
      cn: ["審美感受性高", "同理心強", "人際關係溫和"],
      zh: ["审美感受性高", "同理心强", "人际关系温和"],
    },
    weaknesses: {
    ...
    career: {
      ...
      cn: "適合藝術家、作家、音樂家、教師和醫生。",
      zh: "适合艺术家、作家、音乐家、教师和医生。",
    },
    love: {
      ...
      cn: "與兔年、馬年和豬年分享穩定的愛情。練習表達情感很重要。",
      zh: "与兔年、马年和猪年分享稳定的爱情。练习表达情感很重要。",
    },
  ...
  monkey: {
    ...
    name: { ko: "원숭이", en: "Monkey", ja: "申(サル)", fr: "Singe", es: "Mono", cn: "猴", zh: "猴" },
    traits: {
      ...
      cn: ["聰明", "幽默", "多才多藝", "機會主義", "好奇心強"],
      zh: ["聪明", "幽默", "多才多艺", "机会主义", "好奇心强"],
    },
    strengths: {
      ...
      cn: ["解決問題能力出色", "學習速度快", "社交能力出色"],
      zh: ["解决问题能力出色", "学习速度快", "社交能力出色"],
    },
    weaknesses: {
    ...
    career: {
      ...
      cn: "在企業家、工程師、娛樂、金融和醫學領域表現出色。",
      zh: "在企业家、工程师、娱乐、金融和医学领域表现出色。",
    },
    love: {
      ...
      cn: "與鼠年和龍年有絕佳相容。尋求有智識刺激的關係。",
      zh: "与鼠年和龙年有绝佳相容。寻求有智识刺激的关系。",
    },
  ...
  rooster: {
    ...
    name: { ko: "닭", en: "Rooster", ja: "酉(トリ)", fr: "Coq", es: "Gallo", cn: "雞", zh: "鸡" },
    traits: {
      ...
      cn: ["自信", "完美主義", "觀察力強", "自負", "勤奮"],
      zh: ["自信", "完美主义", "观察力强", "自负", "勤奋"],
    },
    strengths: {
      ...
      cn: ["分析力敏銳", "思維有條理", "時間管理出色"],
      zh: ["分析力敏锐", "思维有条理", "时间管理出色"],
    },
    weaknesses: {
    ...
    career: {
      ...
      cn: "適合會計師、醫生、外科醫生、軍人和探險家。",
      zh: "适合会计师、医生、外科医生、军人和探险家。",
    },
    love: {
      ...
      cn: "與牛年和蛇年建立深厚信任關係。放下一些完美主義會讓關係更幸福。",
      zh: "与牛年和蛇年建立深厚信任关系。放下一些完美主义会让关系更幸福。",
    },
  ...
  dog: {
    ...
    name: { ko: "개", en: "Dog", ja: "戌(イヌ)", fr: "Chien", es: "Perro", cn: "狗", zh: "狗" },
    traits: {
    ...
    strengths: {
      ...
      cn: ["深厚的忠誠心", "公正的判斷力", "奉獻精神"],
      zh: ["深厚的忠诚心", "公正的判断力", "奉献精神"],
    },
    weaknesses: {
    ...
    career: {
      ...
      cn: "適合警察、政治家、社會工作者、教師和醫生。",
      zh: "适合警察、政治家、社会工作者、教师和医生。",
    },
    love: {
      ...
      cn: "與虎年、兔年和馬年建立基於深厚信任的關係。向伴侶展示足夠的信任。",
      zh: "与虎年、兔年和马年建立基于深厚信任的关系。向伴侣展示足够的信任。",
    },
  ...
  pig: {
    ...
    name: { ko: "돼지", en: "Pig", ja: "亥(イノシシ)", fr: "Cochon", es: "Cerdo", cn: "豬", zh: "猪" },
    traits: {
    ...
    strengths: {
      ...
      cn: ["真誠的善意", "樂觀的能量", "強烈的集體精神"],
      zh: ["真诚的善意", "乐观的能量", "强烈的集体精神"],
    },
    weaknesses: {
    ...
    career: {
      ...
      cn: "適合醫生、獸醫、教師、藝術家和商業人士。",
      zh: "适合医生、兽医、教师、艺术家和商业人士。",
    },
    love: {
      ...
      cn: "與虎年、兔年和羊年建立溫暖真誠的關係。學會設定界限也很重要。",
      zh: "与虎年、兔年和羊年建立温暖真诚的关系。学会设定界限也很重要。",
    },
    ...
    <div className="space-y-6">
      ...
      <div className="bg-card border border-gray-100 rounded-2xl p-5 shadow-sm space-y-3">
        ...
        <div className="flex gap-2">
          ...
          <button
            onClick={handleFind}
            className="px-5 py-2.5 bg-green-600 text-primary-foreground rounded-xl font-semibold text-sm hover:bg-primary transition-colors"
          >
            {t.findBtn}
          </button>
        </div>
