...
const QUESTIONS: Question[] = [
  {
    ...
    text: {
      ...
      cn: "你的自然膚色（未化妝時）是什麼感覺？",
      zh: "你的自然肤色（未化妆时）是什么感觉？",
    },
    options: [
      {
        text: {
  ...
  },
  {
    ...
    text: {
      ...
      cn: "純白色和象牙色/米色，哪個更適合你？",
      zh: "纯白色和象牙色/米色，哪个更适合你？",
    },
    options: [
      {
        text: {
    ...
    options: [
      {
        text: {
          ...
          cn: "珊瑚、桃色、黃色等溫暖鮮豔色彩適合我",
          zh: "珊瑚、桃色、黄色等温暖鲜艳色彩适合我",
        },
        scores: { spring: 2 },
      },
      {
      ...
      },
      {
        text: {
          ...
          cn: "深沉溫暖的大地色、芥末黃、磚紅色適合我",
          zh: "深沉温暖的大地色、芥末黄、砖红色适合我",
        },
        scores: { autumn: 2 },
      },
      {
        text: {
          ...
          cn: "冷色調鮮艷顏色或黑白對比在我身上很有衝擊力",
          zh: "冷色调鲜艳颜色或黑白对比在我身上很有冲击力",
        },
        scores: { winter: 2 },
      },
    ],
    ...
    options: [
      ...
      },
      {
        text: {
          ...
          cn: "不容易曬黑，或曬黑後呈現偏藍或灰黑色調",
          zh: "不容易晒黑，或晒黑后呈现偏蓝或灰黑色调",
        },
        scores: { winter: 2 },
      },
    ],
...
const SEASONS: Record<Season, SeasonData> = {
  spring: {
    ...
    name: { ko: "봄 웜톤", en: "Spring Warm", ja: "スプリング ウォーム", fr: "Printemps Chaud", es: "Primavera Cálida", cn: "春暖色", zh: "春暖色" },
    subtitle: {
    ...
    tone: {
      ...
      cn: "帶有金色底調的明亮清透暖色調。肌膚帶有微黃光澤，清晰而生動。特點是象牙白肌膚配玫瑰色臉頰。",
      zh: "带有金色底调的明亮清透暖色调。肌肤带有微黄光泽，清晰而生动。特点是象牙白肌肤配玫瑰色脸颊。",
    },
    bestColors: [
      { name: { ko: "코랄", en: "Coral", ja: "コーラル", fr: "Corail", es: "Coral", cn: "珊瑚色", zh: "珊瑚色" }, hex: "#FF6B6B" },
      { name: { ko: "피치", en: "Peach", ja: "ピーチ", fr: "Pêche", es: "Melocotón", cn: "桃色", zh: "桃色" }, hex: "#FFBE7A" },
      { name: { ko: "골든 옐로우", en: "Golden Yellow", ja: "ゴールデンイエロー", fr: "Jaune doré", es: "Amarillo dorado", cn: "金黃色", zh: "金黄色" }, hex: "#FFD700" },
      { name: { ko: "아이보리", en: "Ivory", ja: "アイボリー", fr: "Ivoire", es: "Marfil", cn: "象牙白", zh: "象牙白" }, hex: "#FFFFF0" },
      { name: { ko: "민트 그린", en: "Mint Green", ja: "ミントグリーン", fr: "Vert menthe", es: "Verde menta", cn: "薄荷綠", zh: "薄荷绿" }, hex: "#98D8C8" },
      { name: { ko: "카멜", en: "Camel", ja: "キャメル", fr: "Camel", es: "Camello", cn: "駝色", zh: "驼色" }, hex: "#C19A6B" },
    ],
    avoidColors: [
      { name: { ko: "블랙", en: "Black", ja: "ブラック", fr: "Noir", es: "Negro", cn: "黑色", zh: "黑色" }, hex: "#000000" },
      { name: { ko: "그레이", en: "Grey", ja: "グレー", fr: "Gris", es: "Gris", cn: "灰色", zh: "灰色" }, hex: "#808080" },
      { name: { ko: "차콜", en: "Charcoal", ja: "チャコール", fr: "Anthracite", es: "Carbón", cn: "炭灰色", zh: "炭灰色" }, hex: "#36454F" },
    ],
    makeup: {
      ...
      cn: ["唇色：珊瑚、桃色、杏色系", "腮紅：桃色、珊瑚色", "眼影：金棕色、銅色", "粉底：象牙色、暖米色"],
      zh: ["唇色：珊瑚、桃色、杏色系", "腮红：桃色、珊瑚色", "眼影：金棕色、铜色", "粉底：象牙色、暖米色"],
    },
    fashion: {
      ...
      cn: ["明亮溫暖的粉彩色系", "珊瑚、桃色、奶油色連衣裙", "金色配飾", "象牙白/奶油色基底優於純白色"],
      zh: ["明亮温暖的粉彩色系", "珊瑚、桃色、奶油色连衣裙", "金色配饰", "象牙白/奶油色基底优于纯白色"],
    },
  ...
  summer: {
    ...
    name: { ko: "여름 쿨톤", en: "Summer Cool", ja: "サマー クール", fr: "Été Frais", es: "Verano Fresco", cn: "夏冷色", zh: "夏冷色" },
    subtitle: {
      ...
      cn: "柔和優雅的冷色調——清爽浪漫的夏日氛圍",
      zh: "柔和优雅的冷色调——清爽浪漫的夏日氛围",
    },
    tone: {
      ...
      cn: "帶粉紅色調的明亮柔和冷色。肌膚帶微紅光澤，透明而細膩。特點是藍底肌膚帶薰衣草底調。",
      zh: "带粉红色调的明亮柔和冷色。肌肤带微红光泽，透明而细腻。特点是蓝底肌肤带薰衣草底调。",
    },
    bestColors: [
      { name: { ko: "로즈핑크", en: "Rose Pink", ja: "ローズピンク", fr: "Rose vif", es: "Rosa vivo", cn: "玫瑰粉", zh: "玫瑰粉" }, hex: "#FF9EAA" },
      { name: { ko: "라벤더", en: "Lavender", ja: "ラベンダー", fr: "Lavande", es: "Lavanda", cn: "薰衣草紫", zh: "薰衣草紫" }, hex: "#B57BED" },
      { name: { ko: "파우더 블루", en: "Powder Blue", ja: "パウダーブルー", fr: "Bleu poudré", es: "Azul polvo", cn: "粉藍色", zh: "粉蓝色" }, hex: "#B0E0E6" },
      { name: { ko: "소프트 화이트", en: "Soft White", ja: "ソフトホワイト", fr: "Blanc doux", es: "Blanco suave", cn: "柔白色", zh: "柔白色" }, hex: "#F5F5F5" },
      { name: { ko: "플럼", en: "Plum", ja: "プラム", fr: "Prune", es: "Ciruela", cn: "梅子色", zh: "梅子色" }, hex: "#8E4585" },
      { name: { ko: "아이시 블루", en: "Icy Blue", ja: "アイシーブルー", fr: "Bleu glacé", es: "Azul helado", cn: "冰藍色", zh: "冰蓝色" }, hex: "#99C5C4" },
    ],
    avoidColors: [
      { name: { ko: "오렌지", en: "Orange", ja: "オレンジ", fr: "Orange", es: "Naranja", cn: "橙色", zh: "橙色" }, hex: "#FF6600" },
      { name: { ko: "머스터드", en: "Mustard", ja: "マスタード", fr: "Moutarde", es: "Mostaza", cn: "芥末黃", zh: "芥末黄" }, hex: "#FFDB58" },
      { name: { ko: "테라코타", en: "Terracotta", ja: "テラコッタ", fr: "Terracotta", es: "Terracota", cn: "磚紅色", zh: "砖红色" }, hex: "#E2725B" },
    ],
    makeup: {
      ...
      cn: ["唇色：玫瑰、酒紅、柔和粉紅系", "腮紅：玫瑰粉、冷粉紅", "眼影：薰衣草、灰色、冷色調紫", "粉底：粉米色、冷米色"],
      zh: ["唇色：玫瑰、酒红、柔和粉红系", "腮红：玫瑰粉、冷粉红", "眼影：薰衣草、灰色、冷色调紫", "粉底：粉米色、冷米色"],
    },
    fashion: {
      ...
      cn: ["粉藍色、薰衣草紫、柔和粉紅", "優雅懸垂風格", "銀色或玫瑰金配飾", "藍底系圖案"],
      zh: ["粉蓝色、薰衣草紫、柔和粉红", "优雅悬垂风格", "银色或玫瑰金配饰", "蓝底系图案"],
    },
  ...
  autumn: {
    ...
    name: { ko: "가을 웜톤", en: "Autumn Warm", ja: "オータム ウォーム", fr: "Automne Chaud", es: "Otoño Cálido", cn: "秋暖色", zh: "秋暖色" },
    subtitle: {
      ...
      cn: "深沉豐富的暖色調——成熟奢華的秋日氛圍",
      zh: "深沉丰富的暖色调——成熟奢华的秋日氛围",
    },
    tone: {
      ...
      cn: "深沉的暖色調，富含金色和橄欖色底調。肌膚帶有濃郁金色光澤，成熟而精緻。特點是深棕色眼睛和溫暖棕色頭髮。",
      zh: "深沉的暖色调，富含金色和橄榄色底调。肌肤带有浓郁金色光泽，成熟而精致。特点是深棕色眼睛和温暖棕色头发。",
    },
    bestColors: [
      { name: { ko: "테라코타", en: "Terracotta", ja: "テラコッタ", fr: "Terracotta", es: "Terracota", cn: "磚紅色", zh: "砖红色" }, hex: "#CC5733" },
      { name: { ko: "머스터드", en: "Mustard", ja: "マスタード", fr: "Moutarde", es: "Mostaza", cn: "芥末黃", zh: "芥末黄" }, hex: "#FFBA00" },
      { name: { ko: "올리브 그린", en: "Olive Green", ja: "オリーブグリーン", fr: "Vert olive", es: "Verde oliva", cn: "橄欖綠", zh: "橄榄绿" }, hex: "#708238" },
      { name: { ko: "번트 오렌지", en: "Burnt Orange", ja: "バーントオレンジ", fr: "Orange brûlé", es: "Naranja quemado", cn: "焦橙色", zh: "焦橙色" }, hex: "#CC5500" },
      { name: { ko: "카멜", en: "Camel", ja: "キャメル", fr: "Camel", es: "Camello", cn: "駝色", zh: "驼色" }, hex: "#C19A6B" },
      { name: { ko: "다크 브라운", en: "Dark Brown", ja: "ダークブラウン", fr: "Brun foncé", es: "Marrón oscuro", cn: "深棕色", zh: "深棕色" }, hex: "#5C4033" },
    ],
    avoidColors: [
      { name: { ko: "블랙", en: "Black", ja: "ブラック", fr: "Noir", es: "Negro", cn: "黑色", zh: "黑色" }, hex: "#000000" },
      { name: { ko: "핑크", en: "Pink", ja: "ピンク", fr: "Rose", es: "Rosa", cn: "粉紅色", zh: "粉红色" }, hex: "#FFC0CB" },
      { name: { ko: "아이시 컬러", en: "Icy Colors", ja: "アイシーカラー", fr: "Couleurs glacées", es: "Colores helados", cn: "冰色調", zh: "冰色调" }, hex: "#D6EAF8" },
    ],
    makeup: {
    ...
    fashion: {
      ...
      cn: ["大地色、橄欖色、芥末黃系", "皮革、麂皮材質", "復古金色配飾", "溫暖層疊穿搭風格"],
      zh: ["大地色、橄榄色、芥末黄系", "皮革、麂皮材质", "复古金色配饰", "温暖层叠穿搭风格"],
    },
  ...
  winter: {
    ...
    name: { ko: "겨울 쿨톤", en: "Winter Cool", ja: "ウィンター クール", fr: "Hiver Froid", es: "Invierno Frío", cn: "冬冷色", zh: "冬冷色" },
    subtitle: {
      ...
      cn: "清晰強烈的冷色調——精緻有魅力的冬日氣場",
      zh: "清晰强烈的冷色调——精致有魅力的冬日气场",
    },
    tone: {
      ...
      cn: "冷冽清晰的藍底冷色調。肌膚明亮透明或偏深，形成強烈對比感。特點是黑色眼睛和深色頭髮。",
      zh: "冷冽清晰的蓝底冷色调。肌肤明亮透明或偏深，形成强烈对比感。特点是黑色眼睛和深色头发。",
    },
    bestColors: [
      { name: { ko: "퓨어 화이트", en: "Pure White", ja: "ピュアホワイト", fr: "Blanc pur", es: "Blanco puro", cn: "純白", zh: "纯白" }, hex: "#FFFFFF" },
      { name: { ko: "블랙", en: "Black", ja: "ブラック", fr: "Noir", es: "Negro", cn: "黑色", zh: "黑色" }, hex: "#000000" },
      { name: { ko: "로열 블루", en: "Royal Blue", ja: "ロイヤルブルー", fr: "Bleu royal", es: "Azul real", cn: "皇家藍", zh: "皇家蓝" }, hex: "#4169E1" },
      { name: { ko: "버건디", en: "Burgundy", ja: "バーガンディ", fr: "Bordeaux", es: "Burdeos", cn: "酒紅色", zh: "酒红色" }, hex: "#800020" },
      { name: { ko: "에메랄드", en: "Emerald", ja: "エメラルド", fr: "Émeraude", es: "Esmeralda", cn: "翡翠綠", zh: "翡翠绿" }, hex: "#50C878" },
      { name: { ko: "마젠타", en: "Magenta", ja: "マゼンタ", fr: "Magenta", es: "Magenta", cn: "洋紅色", zh: "洋红色" }, hex: "#FF00FF" },
    ],
    avoidColors: [
      { name: { ko: "오렌지", en: "Orange", ja: "オレンジ", fr: "Orange", es: "Naranja", cn: "橙色", zh: "橙色" }, hex: "#FF6600" },
      { name: { ko: "베이지", en: "Beige", ja: "ベージュ", fr: "Beige", es: "Beige", cn: "米色", zh: "米色" }, hex: "#F5F5DC" },
      { name: { ko: "카멜", en: "Camel", ja: "キャメル", fr: "Camel", es: "Camello", cn: "駝色", zh: "驼色" }, hex: "#C19A6B" },
    ],
    makeup: {
      ...
      cn: ["唇色：紅色、酒紅、深樱桃、莓果系", "腮紅：冷粉紅、玫瑰色", "眼影：黑色、灰色、深藏青色", "粉底：冷米色、粉米色"],
      zh: ["唇色：红色、酒红、深樱桃、莓果系", "腮红：冷粉红、玫瑰色", "眼影：黑色、灰色、深藏青色", "粉底：冷米色、粉米色"],
    },
    fashion: {
      ...
      cn: ["黑白灰單色調", "強烈鮮豔色彩點綴", "銀色配飾", "利落結構感輪廓"],
      zh: ["黑白灰单色调", "强烈鲜艳色彩点缀", "银色配饰", "利落结构感轮廓"],
    },
