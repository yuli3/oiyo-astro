...
const QUESTIONS: Question[] = [
  {
    ...
    options: [
      { text: { ko: "실컷 울고 싶다", en: "Cry it all out", ja: "思いきり泣きたい", fr: "Pleurer à chaudes larmes", es: "Llorar todo lo que pueda", cn: "痛痛快快地哭一场", zh: "痛痛快快地哭一場" }, type: "stormy" },
      { text: { ko: "일기를 쓰며 정리하고 싶다", en: "Write in my journal to process it", ja: "日記を書いて整理したい", fr: "Écrire dans mon journal pour y voir clair", es: "Escribir en mi diario para procesarlo", cn: "写日记整理思绪", zh: "寫日記整理思緒" }, type: "growth" },
      { text: { ko: "혼자 있고 싶다", en: "Be alone for a while", ja: "一人でいたい", fr: "Rester seul(e) un moment", es: "Estar solo/a por un tiempo", cn: "想独处一段时间", zh: "想獨處一段時間" }, type: "solitary" },
      { text: { ko: "여행을 떠나고 싶다", en: "Go on a trip", ja: "旅に出たい", fr: "Partir en voyage", es: "Irme de viaje", cn: "想去旅行", zh: "想去旅行" }, type: "transformer" },
    ],
  },
  {
    id: 2,
    ...
    options: [
      { text: { ko: "분노와 슬픔이 교차할 때", en: "When anger and sadness alternate", ja: "怒りと悲しみが交差するとき", fr: "Quand la colère et la tristesse alternent", es: "Cuando la ira y la tristeza se alternan", cn: "愤怒和悲伤交替出现时", zh: "憤怒和悲傷交替出現時" }, type: "stormy" },
      { text: { ko: "왜 이렇게 됐는지 이해하려 할 때", en: "When I try to understand why it happened", ja: "なぜこうなったか理解しようとするとき", fr: "Quand j'essaie de comprendre pourquoi ça s'est passé", es: "Cuando intento entender por qué pasó", cn: "试图理解为什么会这样时", zh: "試圖理解為什麼會這樣時" }, type: "growth" },
      { text: { ko: "아무도 이해 못할 것 같은 외로움", en: "Loneliness that no one seems to understand", ja: "誰も理解できないような孤独感", fr: "La solitude que personne ne semble comprendre", es: "La soledad que nadie parece entender", cn: "无人理解的孤独感", zh: "無人理解的孤獨感" }, type: "solitary" },
      { text: { ko: "일상이 텅 빈 느낌이 들 때", en: "When my daily routine feels empty", ja: "日常が空虚に感じるとき", fr: "Quand ma routine quotidienne semble vide", es: "Cuando mi rutina diaria parece vacía", cn: "日常生活感到空洞时", zh: "日常生活感到空洞時" }, type: "transformer" },
    ],
  },
  {
    id: 3,
    ...
    options: [
      { text: { ko: "모든 걸 털어놓고 감정을 쏟아낸다", en: "Pour out all my feelings", ja: "すべてを打ち明けて感情を吐き出す", fr: "Tout déverser et exprimer mes émotions", es: "Desahogarme y expresar todos mis sentimientos", cn: "倾诉一切，宣泄情绪", zh: "傾訴一切，宣洩情緒" }, type: "stormy" },
      { text: { ko: "무슨 일이 있었는지 차분하게 정리해서 말한다", en: "Calmly explain what happened", ja: "何があったか落ち着いて整理して話す", fr: "Expliquer calmement ce qui s'est passé", es: "Explicar tranquilamente lo que pasó", cn: "平静地梳理并讲述发生了什么", zh: "平靜地梳理並講述發生了什麼" }, type: "growth" },
      { text: { ko: "\"괜찮아\"라고 하고 혼자 정리한다", en: "Say 'I'm fine' and process it alone", ja: "「大丈夫」と言って一人で整理する", fr: "Dire « ça va » et le traiter seul(e)", es: "Decir 'estoy bien' y procesarlo solo/a", cn: "说「我没事」然后独自消化", zh: "說「我沒事」然後獨自消化" }, type: "solitary" },
      { text: { ko: "같이 뭔가 하자고 제안한다 (운동, 쇼핑 등)", en: "Suggest doing something together (gym, shopping, etc.)", ja: "一緒に何かしようと提案する（運動、ショッピングなど）", fr: "Proposer de faire quelque chose ensemble (sport, shopping…)", es: "Sugerir hacer algo juntos (gym, compras, etc.)", cn: "提议一起做些事（运动、购物等）", zh: "提議一起做些事（運動、購物等）" }, type: "transformer" },
    ],
  },
  {
    id: 4,
    ...
    options: [
      { text: { ko: "폭풍처럼 감정이 요동친다", en: "My emotions surge like a storm", ja: "嵐のように感情が揺れる", fr: "Mes émotions déferlent comme une tempête", es: "Mis emociones se agitan como una tormenta", cn: "情绪如暴风雨般汹涌", zh: "情緒如暴風雨般洶湧" }, type: "stormy" },
      { text: { ko: "자신을 돌아보고 성찰한다", en: "I reflect and look inward", ja: "自分を振り返って内省する", fr: "Je réfléchis et me remets en question", es: "Reflexiono e introspecciono", cn: "反省自我，深刻内省", zh: "反省自我，深刻內省" }, type: "growth" },
      { text: { ko: "혼자 조용히 시간을 보낸다", en: "I spend quiet time alone", ja: "一人で静かに時間を過ごす", fr: "Je passe du temps seul(e) et tranquille", es: "Paso tiempo tranquilo/a solo/a", cn: "独自安静地度过时光", zh: "獨自安靜地度過時光" }, type: "solitary" },
      { text: { ko: "새로운 취미나 활동을 찾는다", en: "I search for new hobbies or activities", ja: "新しい趣味や活動を探す", fr: "Je cherche de nouveaux loisirs ou activités", es: "Busco nuevos pasatiempos o actividades", cn: "寻找新的爱好或活动", zh: "尋找新的愛好或活動" }, type: "transformer" },
    ],
  },
  {
    id: 5,
    ...
    options: [
      { text: { ko: "마음이 뒤흔들려 한동안 힘들다", en: "Get shaken up and struggle for a while", ja: "心が揺れてしばらく辛くなる", fr: "Être bouleversé(e) et avoir du mal pendant un moment", es: "Me sacudo y me cuesta por un tiempo", cn: "内心动荡，难受很久", zh: "內心動盪，難受很久" }, type: "stormy" },
      { text: { ko: "보지 않는 게 낫다고 생각하며 차단한다", en: "Think it's better not to see it and block them", ja: "見ない方がいいと考えてブロックする", fr: "Décider qu'il vaut mieux ne pas le voir et les bloquer", es: "Pensar que es mejor no verlo y bloquearlos", cn: "认为最好不看并屏蔽对方", zh: "認為最好不看並封鎖對方" }, type: "growth" },
      { text: { ko: "무감각하게 보고 그냥 덮는다", en: "Look at it numbly and close it", ja: "無感覚に見てそのまま閉じる", fr: "Le regarder sans émotion et fermer", es: "Mirarlo sin emoción y cerrarlo", cn: "麻木地看完然后关掉", zh: "麻木地看完然後關掉" }, type: "solitary" },
      { text: { ko: "나도 뭔가 올리고 싶어진다 (나의 근황 업데이트)", en: "Feel like posting something about myself too", ja: "自分も何か投稿したくなる（自分の近況更新）", fr: "Avoir envie de poster quelque chose sur moi aussi", es: "Querer publicar algo sobre mí también", cn: "想发一条自己的动态", zh: "想發一條自己的動態" }, type: "transformer" },
    ],
  },
  {
    id: 6,
    ...
    options: [
      { text: { ko: "감정을 표현할 공간과 사람", en: "Space and people to express emotions", ja: "感情を表現できる場所と人", fr: "Un espace et des gens pour exprimer ses émotions", es: "Espacio y personas para expresar emociones", cn: "能表达情绪的空间和人", zh: "能表達情緒的空間和人" }, type: "stormy" },
      { text: { ko: "이별의 의미를 깨닫는 성찰 시간", en: "Time to reflect on the meaning of the breakup", ja: "別れの意味を悟る内省の時間", fr: "Du temps pour réfléchir au sens de la rupture", es: "Tiempo para reflexionar sobre el significado de la ruptura", cn: "领悟分手意义的反思时间", zh: "領悟分手意義的反思時間" }, type: "growth" },
      { text: { ko: "아무 방해 없는 고요한 시간", en: "Quiet time without any interruptions", ja: "邪魔のない静かな時間", fr: "Du calme sans aucune interruption", es: "Tiempo tranquilo sin interrupciones", cn: "不受打扰的安静时光", zh: "不受打擾的安靜時光" }, type: "solitary" },
      { text: { ko: "새로운 도전과 자극", en: "New challenges and stimulation", ja: "新たな挑戦と刺激", fr: "De nouveaux défis et de la stimulation", es: "Nuevos desafíos y estimulación", cn: "新的挑战和刺激", zh: "新的挑戰和刺激" }, type: "transformer" },
    ],
  },
  {
    id: 7,
    ...
    options: [
      { text: { ko: "아직도 격렬한 감정의 파도 속에 있다", en: "Still in waves of intense emotion", ja: "まだ激しい感情の波の中にいる", fr: "Encore dans des vagues d'émotions intenses", es: "Todavía en olas de emociones intensas", cn: "仍在激烈的情绪波涛中", zh: "仍在激烈的情緒波濤中" }, type: "stormy" },
      { text: { ko: "관계에서 배운 점을 정리하고 있다", en: "Organizing what I learned from the relationship", ja: "関係から学んだことを整理している", fr: "En train d'organiser ce que j'ai appris de la relation", es: "Organizando lo que aprendí de la relación", cn: "整理从这段关系中学到的东西", zh: "整理從這段關係中學到的東西" }, type: "growth" },
      { text: { ko: "조용히 일상을 유지하고 있다", en: "Quietly maintaining my daily routine", ja: "静かに日常を維持している", fr: "En train de maintenir calmement ma routine quotidienne", es: "Manteniendo tranquilamente mi rutina diaria", cn: "安静地维持日常生活", zh: "安靜地維持日常生活" }, type: "solitary" },
      { text: { ko: "이미 뭔가 새로운 걸 시작했다", en: "Already started something new", ja: "すでに何か新しいことを始めた", fr: "J'ai déjà commencé quelque chose de nouveau", es: "Ya empecé algo nuevo", cn: "已经开始了新的事情", zh: "已經開始了新的事情" }, type: "transformer" },
    ],
  },
  {
    id: 8,
    ...
    options: [
      { text: { ko: "이별은 언제나 아프고 격렬한 경험이다", en: "Breakups are always painful and intense", ja: "別れはいつも痛くて激しい経験だ", fr: "Les ruptures sont toujours douloureuses et intenses", es: "Las rupturas siempre son dolorosas e intensas", cn: "分手永远是痛苦而激烈的体验", zh: "分手永遠是痛苦而激烈的體驗" }, type: "stormy" },
      { text: { ko: "이별은 성장의 기회다", en: "Breakups are opportunities for growth", ja: "別れは成長の機会だ", fr: "Les ruptures sont des opportunités de croissance", es: "Las rupturas son oportunidades de crecimiento", cn: "分手是成长的机会", zh: "分手是成長的機會" }, type: "growth" },
      { text: { ko: "이별 후엔 혼자 시간이 필요하다", en: "I need alone time after a breakup", ja: "別れた後は一人の時間が必要だ", fr: "J'ai besoin de temps seul(e) après une rupture", es: "Necesito tiempo solo/a después de una ruptura", cn: "分手后需要独处时间", zh: "分手後需要獨處時間" }, type: "solitary" },
      { text: { ko: "이별은 새로운 시작의 신호다", en: "A breakup is a signal for a new beginning", ja: "別れは新しい始まりのサインだ", fr: "Une rupture est un signal pour un nouveau départ", es: "Una ruptura es una señal para un nuevo comienzo", cn: "分手是新开始的信号", zh: "分手是新開始的信號" }, type: "transformer" },
    ],
  },
  {
    id: 9,
    ...
    options: [
      { text: { ko: "음악을 크게 틀거나 감정적인 영화를 본다", en: "Blast music or watch emotional movies", ja: "音楽を大きくかけたり感情的な映画を見る", fr: "Mettre de la musique fort ou regarder des films émouvants", es: "Poner música a todo volumen o ver películas emotivas", cn: "大声放音乐或看感人的电影", zh: "大聲放音樂或看感人的電影" }, type: "stormy" },
      { text: { ko: "생각을 정리하며 메모를 한다", en: "Organize my thoughts and take notes", ja: "考えを整理しながらメモをとる", fr: "Organiser mes pensées et prendre des notes", es: "Organizar mis pensamientos y tomar notas", cn: "整理思绪并做笔记", zh: "整理思緒並做筆記" }, type: "growth" },
      { text: { ko: "그냥 조용히 천장을 바라본다", en: "Just stare at the ceiling quietly", ja: "ただ静かに天井を見つめる", fr: "Fixer le plafond tranquillement", es: "Solo mirar el techo en silencio", cn: "静静地盯着天花板", zh: "靜靜地盯著天花板" }, type: "solitary" },
      { text: { ko: "내일 할 계획이나 목표를 세운다", en: "Plan tomorrow's goals or activities", ja: "明日の計画や目標を立てる", fr: "Planifier les objectifs ou activités de demain", es: "Planificar las metas o actividades de mañana", cn: "制定明天的计划或目标", zh: "制定明天的計劃或目標" }, type: "transformer" },
    ],
  },
  {
    id: 10,
    text: {
      ...
      cn: "分手一个月后，你希望自己是什么状态？",
      zh: "分手一個月後，你希望自己是什麼狀態？",
    },
    options: [
      { text: { ko: "감정이 정화되어 가벼워진 상태", en: "Emotionally purged and lighter", ja: "感情が浄化されて軽くなった状態", fr: "Émotionnellement purgé(e) et plus léger(ère)", es: "Emocionalmente purificado/a y más ligero/a", cn: "情绪得到净化，轻松自在", zh: "情緒得到淨化，輕鬆自在" }, type: "stormy" },
      { text: { ko: "더 나은 나로 성장해있는 상태", en: "Grown into a better version of myself", ja: "より良い自分に成長している状態", fr: "Évolué(e) vers une meilleure version de moi-même", es: "Habiendo crecido hacia una mejor versión de mí", cn: "成长为更好的自己", zh: "成長為更好的自己" }, type: "growth" },
      { text: { ko: "평온하고 안정된 내면의 상태", en: "At peace with a stable inner state", ja: "穏やかで安定した内面の状態", fr: "Serein(e) avec un état intérieur stable", es: "En paz con un estado interior estable", cn: "内心平静安定", zh: "內心平靜安定" }, type: "solitary" },
      { text: { ko: "새로운 삶의 방향이 잡힌 상태", en: "Having found a new direction in life", ja: "新しい人生の方向性が定まった状態", fr: "Avoir trouvé une nouvelle direction dans la vie", es: "Habiendo encontrado una nueva dirección en la vida", cn: "找到了人生新方向", zh: "找到了人生新方向" }, type: "transformer" },
    ],
  },
  {
    id: 11,
    ...
    options: [
      { text: { ko: "공감해주고 함께 울어주는 친구", en: "A friend who empathizes and cries with you", ja: "共感して一緒に泣いてくれる友人", fr: "Un ami qui compatit et pleure avec vous", es: "Un amigo que empatiza y llora contigo", cn: "能感同身受、一起哭泣的朋友", zh: "能感同身受、一起哭泣的朋友" }, type: "stormy" },
      { text: { ko: "통찰력 있는 조언을 해주는 사람", en: "Someone who gives insightful advice", ja: "洞察力のあるアドバイスをしてくれる人", fr: "Quelqu'un qui donne des conseils avisés", es: "Alguien que da consejos perspicaces", cn: "给你深刻建议的人", zh: "給你深刻建議的人" }, type: "growth" },
      { text: { ko: "조용히 곁에 있어주는 사람", en: "Someone who quietly stays by your side", ja: "静かにそばにいてくれる人", fr: "Quelqu'un qui reste tranquillement à vos côtés", es: "Alguien que se queda tranquilamente a tu lado", cn: "静静陪伴在你身边的人", zh: "靜靜陪伴在你身邊的人" }, type: "solitary" },
      { text: { ko: "새로운 경험을 함께 해주는 사람", en: "Someone who shares new experiences with you", ja: "新しい経験を一緒にしてくれる人", fr: "Quelqu'un qui partage de nouvelles expériences avec vous", es: "Alguien que comparte nuevas experiencias contigo", cn: "与你共享新体验的人", zh: "與你共享新體驗的人" }, type: "transformer" },
    ],
  },
  {
    id: 12,
    ...
    options: [
      { text: { ko: "감정 해소 & 빠른 회복", en: "Emotional release & fast recovery", ja: "感情解放 & 早期回復", fr: "Libération émotionnelle & rétablissement rapide", es: "Liberación emocional & recuperación rápida", cn: "情绪释放 & 快速恢复", zh: "情緒釋放 & 快速恢復" }, type: "stormy" },
      { text: { ko: "성찰 & 자기 성장", en: "Reflection & self-growth", ja: "内省 & 自己成長", fr: "Réflexion & croissance personnelle", es: "Reflexión & crecimiento personal", cn: "反思 & 自我成长", zh: "反思 & 自我成長" }, type: "growth" },
      { text: { ko: "고독 & 내면 치유", en: "Solitude & inner healing", ja: "孤独 & 内なる癒し", fr: "Solitude & guérison intérieure", es: "Soledad & sanación interior", cn: "独处 & 内在疗愈", zh: "獨處 & 內在療癒" }, type: "solitary" },
      { text: { ko: "전환 & 새로운 시작", en: "Transformation & new beginnings", ja: "転換 & 新たな始まり", fr: "Transformation & nouveaux départs", es: "Transformación & nuevos comienzos", cn: "转变 & 新的开始", zh: "轉變 & 新的開始" }, type: "transformer" },
    ],
  },
];
...
const RESULTS: Record<RecoveryType, TypeResult> = {
  stormy: {
    ...
    description: {
      ...
      cn: "你是一个强烈感受和表达情绪的类型。分手后情绪波涛汹涌，但一旦充分处理，恢复也很快。与其压抑情绪，充分感受和表达才是你的治愈方式。身边人的共情和支持对你是巨大的力量。",
      zh: "你是一個強烈感受和表達情緒的類型。分手後情緒波濤洶湧，但一旦充分處理，恢復也很快。與其壓抑情緒，充分感受和表達才是你的療癒方式。身邊人的共情和支持對你是巨大的力量。",
    },
    tips: {
      ...
      cn: ["写情绪日记——把愤怒和悲伤倾泻在纸上", "找信任的朋友彻底倾诉", "通过激烈运动健康地释放情绪能量"],
      zh: ["寫情緒日記——把憤怒和悲傷傾瀉在紙上", "找信任的朋友徹底傾訴", "通過激烈運動健康地釋放情緒能量"],
    },
    bestMatch: {
      ...
      cn: "成长型——能共情你的感受，同时帮你找到方向",
      zh: "成長型——能共情你的感受，同時幫你找到方向",
    },
    caution: {
      ...
      cn: "注意不要在情绪中停留太久。感受够了之后，向前走也是一种勇气。",
      zh: "注意不要在情緒中停留太久。感受夠了之後，向前走也是一種勇氣。",
    },
  },
  growth: {
    emoji: "🌱",
    ...
    description: {
      ...
      cn: "你是那种以分手为跳板、成就更好自己的类型。你珍视从关系中学到的东西，即使在痛苦中也有找到意义的卓越能力。通过分手后的自我反省和内心探索，你构建了更坚强的自我。在未来的关系中，你很可能展现出更成熟的一面。",
      zh: "你是那種以分手為跳板、成就更好自己的類型。你珍視從關係中學到的東西，即使在痛苦中也有找到意義的卓越能力。通過分手後的自我反省和內心探索，你構建了更堅強的自我。在未來的關係中，你很可能展現出更成熟的一面。",
    },
    tips: {
      ...
      cn: ["列出你从这段关系中学到的东西", "通过心理学书籍或播客拓展自我认知", "通过咨询或辅导进行更深刻的反思"],
      zh: ["列出你從這段關係中學到的東西", "通過心理學書籍或播客拓展自我認知", "通過諮詢或輔導進行更深刻的反思"],
    },
    bestMatch: {
      ...
      cn: "激流型——你的平静能帮助稳定他们激烈的情绪",
      zh: "激流型——你的平靜能幫助穩定他們激烈的情緒",
    },
    caution: {
      ...
      cn: "注意不要过于理性分析而忽视情绪。有时候，单纯地感受就已经足够了。",
      zh: "注意不要過於理性分析而忽視情緒。有時候，單純地感受就已經足夠了。",
    },
  },
  solitary: {
    emoji: "🌙",
    ...
    description: {
      ...
      cn: "你是那种在独处中静静疗愈自己的类型。你不畏惧孤独，能在寂静中找到属于自己的平和。分手后，你静静地维持日常生活，恢复内心的稳定。独处空间对你的恢复可能比他人的安慰更有帮助。",
      zh: "你是那種在獨處中靜靜療癒自己的類型。你不畏懼孤獨，能在寂靜中找到屬於自己的平和。分手後，你靜靜地維持日常生活，恢復內心的穩定。獨處空間對你的恢復可能比他人的安慰更有幫助。",
    },
    tips: {
      ...
      cn: ["通过冥想或正念培养内心平静", "在大自然中散步让心平静下来", "用喜欢的书或音乐创建专属的疗愈日常"],
      zh: ["通過冥想或正念培養內心平靜", "在大自然中散步讓心平靜下來", "用喜歡的書或音樂創建專屬的療愈日常"],
    },
    bestMatch: {
      ...
      cn: "转变型——能静静陪伴你，同时带来新的刺激",
      zh: "轉變型——能靜靜陪伴你，同時帶來新的刺激",
    },
    caution: {
      ...
      cn: "注意不要太深地沉入孤独中。偶尔寻求帮助也是一种力量的表现。",
      zh: "注意不要太深地沉入孤獨中。偶爾尋求幫助也是一種力量的表現。",
    },
  },
  transformer: {
    emoji: "🦋",
    ...
    description: {
      ...
      cn: "你是那种分手后将能量转化为新活动和体验的类型。你不惧怕变化，反而将分手视为新开始的机会。通过行动向前迈进是你最有效的疗愈方式。你像蝴蝶一样，拥有通过变化变得更美好的潜力。",
      zh: "你是那種分手後將能量轉化為新活動和體驗的類型。你不懼怕變化，反而將分手視為新開始的機會。通過行動向前邁進是你最有效的療愈方式。你像蝴蝶一樣，擁有通過變化變得更美好的潛力。",
    },
    tips: {
      ...
      cn: ["现在就开始那个你一直想尝试的爱好或挑战", "通过旅行或拜访新地方转换心情", "加入可以结交新朋友的团体或社群"],
      zh: ["現在就開始那個你一直想嘗試的愛好或挑戰", "通過旅行或拜訪新地方轉換心情", "加入可以結交新朋友的團體或社群"],
    },
    bestMatch: {
      ...
      cn: "独处型——你活跃的能量能为他们带来新的刺激",
      zh: "獨處型——你活躍的能量能為他們帶來新的刺激",
    },
    caution: {
      ...
      cn: "注意不要因为太忙而回避情绪。你也需要暂停下来，审视内心的时间。",
      zh: "注意不要因為太忙而迴避情緒。你也需要暫停下來，審視內心的時間。",
    },
  },
};
