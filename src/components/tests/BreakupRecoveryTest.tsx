...
const QUESTIONS: Question[] = [
  {
    ...
    options: [
      { text: { ko: "실컷 울고 싶다", en: "Cry it all out", ja: "思いきり泣きたい", fr: "Pleurer à chaudes larmes", es: "Llorar todo lo que pueda", cn: "痛痛快快地哭一场", zh: "痛痛快快地哭一场" }, type: "stormy" },
      { text: { ko: "일기를 쓰며 정리하고 싶다", en: "Write in my journal to process it", ja: "日記を書いて整理したい", fr: "Écrire dans mon journal pour y voir clair", es: "Escribir en mi diario para procesarlo", cn: "写日记整理思绪", zh: "写日记整理思绪" }, type: "growth" },
      { text: { ko: "혼자 있고 싶다", en: "Be alone for a while", ja: "一人でいたい", fr: "Rester seul(e) un moment", es: "Estar solo/a por un tiempo", cn: "想独处一段时间", zh: "想独处一段时间" }, type: "solitary" },
  ...
  },
  {
    ...
    options: [
      { text: { ko: "분노와 슬픔이 교차할 때", en: "When anger and sadness alternate", ja: "怒りと悲しみが交差するとき", fr: "Quand la colère et la tristesse alternent", es: "Cuando la ira y la tristeza se alternan", cn: "愤怒和悲伤交替出现时", zh: "愤怒和悲伤交替出现时" }, type: "stormy" },
      { text: { ko: "왜 이렇게 됐는지 이해하려 할 때", en: "When I try to understand why it happened", ja: "なぜこうなったか理解しようとするとき", fr: "Quand j'essaie de comprendre pourquoi ça s'est passé", es: "Cuando intento entender por qué pasó", cn: "试图理解为什么会这样时", zh: "试图理解为什么会这样时" }, type: "growth" },
      { text: { ko: "아무도 이해 못할 것 같은 외로움", en: "Loneliness that no one seems to understand", ja: "誰も理解できないような孤独感", fr: "La solitude que personne ne semble comprendre", es: "La soledad que nadie parece entender", cn: "无人理解的孤独感", zh: "无人理解的孤独感" }, type: "solitary" },
      { text: { ko: "일상이 텅 빈 느낌이 들 때", en: "When my daily routine feels empty", ja: "日常が空虚に感じるとき", fr: "Quand ma routine quotidienne semble vide", es: "Cuando mi rutina diaria parece vacía", cn: "日常生活感到空洞时", zh: "日常生活感到空洞时" }, type: "transformer" },
    ],
  },
  {
    id: 3,
    ...
    options: [
      { text: { ko: "모든 걸 털어놓고 감정을 쏟아낸다", en: "Pour out all my feelings", ja: "すべてを打ち明けて感情を吐き出す", fr: "Tout déverser et exprimer mes émotions", es: "Desahogarme y expresar todos mis sentimientos", cn: "倾诉一切，宣泄情绪", zh: "倾诉一切，宣泄情绪" }, type: "stormy" },
      { text: { ko: "무슨 일이 있었는지 차분하게 정리해서 말한다", en: "Calmly explain what happened", ja: "何があったか落ち着いて整理して話す", fr: "Expliquer calmement ce qui s'est passé", es: "Explicar tranquilamente lo que pasó", cn: "平静地梳理并讲述发生了什么", zh: "平静地梳理并讲述发生了什么" }, type: "growth" },
      { text: { ko: "\"괜찮아\"라고 하고 혼자 정리한다", en: "Say 'I'm fine' and process it alone", ja: "「大丈夫」と言って一人で整理する", fr: "Dire « ça va » et le traiter seul(e)", es: "Decir 'estoy bien' y procesarlo solo/a", cn: "说「我没事」然后独自消化", zh: "说「我没事」然后独自消化" }, type: "solitary" },
      { text: { ko: "같이 뭔가 하자고 제안한다 (운동, 쇼핑 등)", en: "Suggest doing something together (gym, shopping, etc.)", ja: "一緒に何かしようと提案する（運動、ショッピングなど）", fr: "Proposer de faire quelque chose ensemble (sport, shopping…)", es: "Sugerir hacer algo juntos (gym, compras, etc.)", cn: "提议一起做些事（运动、购物等）", zh: "提议一起做些事（运动、购物等）" }, type: "transformer" },
    ],
  },
  {
    id: 4,
    ...
    options: [
      { text: { ko: "폭풍처럼 감정이 요동친다", en: "My emotions surge like a storm", ja: "嵐のように感情が揺れる", fr: "Mes émotions déferlent comme une tempête", es: "Mis emociones se agitan como una tormenta", cn: "情绪如暴风雨般汹涌", zh: "情绪如暴风雨般汹涌" }, type: "stormy" },
      { text: { ko: "자신을 돌아보고 성찰한다", en: "I reflect and look inward", ja: "自分を振り返って内省する", fr: "Je réfléchis et me remets en question", es: "Reflexiono e introspecciono", cn: "反省自我，深刻内省", zh: "反省自我，深刻内省" }, type: "growth" },
      { text: { ko: "혼자 조용히 시간을 보낸다", en: "I spend quiet time alone", ja: "一人で静かに時間を過ごす", fr: "Je passe du temps seul(e) et tranquille", es: "Paso tiempo tranquilo/a solo/a", cn: "独自安静地度过时光", zh: "独自安静地度过时光" }, type: "solitary" },
      { text: { ko: "새로운 취미나 활동을 찾는다", en: "I search for new hobbies or activities", ja: "新しい趣味や活動を探す", fr: "Je cherche de nouveaux loisirs ou activités", es: "Busco nuevos pasatiempos o actividades", cn: "寻找新的爱好或活动", zh: "寻找新的爱好或活动" }, type: "transformer" },
    ],
  },
  {
    id: 5,
    ...
    options: [
      { text: { ko: "마음이 뒤흔들려 한동안 힘들다", en: "Get shaken up and struggle for a while", ja: "心が揺れてしばらく辛くなる", fr: "Être bouleversé(e) et avoir du mal pendant un moment", es: "Me sacudo y me cuesta por un tiempo", cn: "内心动荡，难受很久", zh: "内心动荡，难受很久" }, type: "stormy" },
      { text: { ko: "보지 않는 게 낫다고 생각하며 차단한다", en: "Think it's better not to see it and block them", ja: "見ない方がいいと考えてブロックする", fr: "Décider qu'il vaut mieux ne pas le voir et les bloquer", es: "Pensar que es mejor no verlo y bloquearlos", cn: "认为最好不看并屏蔽对方", zh: "认为最好不看并封锁对方" }, type: "growth" },
      { text: { ko: "무감각하게 보고 그냥 덮는다", en: "Look at it numbly and close it", ja: "無感覚に見てそのまま閉じる", fr: "Le regarder sans émotion et fermer", es: "Mirarlo sin emoción y cerrarlo", cn: "麻木地看完然后关掉", zh: "麻木地看完然后关掉" }, type: "solitary" },
      { text: { ko: "나도 뭔가 올리고 싶어진다 (나의 근황 업데이트)", en: "Feel like posting something about myself too", ja: "自分も何か投稿したくなる（自分の近況更新）", fr: "Avoir envie de poster quelque chose sur moi aussi", es: "Querer publicar algo sobre mí también", cn: "想发一条自己的动态", zh: "想发一条自己的动态" }, type: "transformer" },
    ],
  },
  {
    id: 6,
    ...
    options: [
      { text: { ko: "감정을 표현할 공간과 사람", en: "Space and people to express emotions", ja: "感情を表現できる場所と人", fr: "Un espace et des gens pour exprimer ses émotions", es: "Espacio y personas para expresar emociones", cn: "能表达情绪的空间和人", zh: "能表达情绪的空间和人" }, type: "stormy" },
      { text: { ko: "이별의 의미를 깨닫는 성찰 시간", en: "Time to reflect on the meaning of the breakup", ja: "別れの意味を悟る内省の時間", fr: "Du temps pour réfléchir au sens de la rupture", es: "Tiempo para reflexionar sobre el significado de la ruptura", cn: "领悟分手意义的反思时间", zh: "领悟分手意义的反思时间" }, type: "growth" },
      { text: { ko: "아무 방해 없는 고요한 시간", en: "Quiet time without any interruptions", ja: "邪魔のない静かな時間", fr: "Du calme sans aucune interruption", es: "Tiempo tranquilo sin interrupciones", cn: "不受打扰的安静时光", zh: "不受打扰的安静时光" }, type: "solitary" },
      { text: { ko: "새로운 도전과 자극", en: "New challenges and stimulation", ja: "新たな挑戦と刺激", fr: "De nouveaux défis et de la stimulation", es: "Nuevos desafíos y estimulación", cn: "新的挑战和刺激", zh: "新的挑战和刺激" }, type: "transformer" },
    ],
  },
  {
    id: 7,
    ...
    options: [
      { text: { ko: "아직도 격렬한 감정의 파도 속에 있다", en: "Still in waves of intense emotion", ja: "まだ激しい感情の波の中にいる", fr: "Encore dans des vagues d'émotions intenses", es: "Todavía en olas de emociones intensas", cn: "仍在激烈的情绪波涛中", zh: "仍在激烈的情绪波涛中" }, type: "stormy" },
      { text: { ko: "관계에서 배운 점을 정리하고 있다", en: "Organizing what I learned from the relationship", ja: "関係から学んだことを整理している", fr: "En train d'organiser ce que j'ai appris de la relation", es: "Organizando lo que aprendí de la relación", cn: "整理从这段关系中学到的东西", zh: "整理从这段关系中学到的东西" }, type: "growth" },
      { text: { ko: "조용히 일상을 유지하고 있다", en: "Quietly maintaining my daily routine", ja: "静かに日常を維持している", fr: "En train de maintenir calmement ma routine quotidienne", es: "Manteniendo tranquilamente mi rutina diaria", cn: "安静地维持日常生活", zh: "安静地维持日常生活" }, type: "solitary" },
      { text: { ko: "이미 뭔가 새로운 걸 시작했다", en: "Already started something new", ja: "すでに何か新しいことを始めた", fr: "J'ai déjà commencé quelque chose de nouveau", es: "Ya empecé algo nuevo", cn: "已经开始了新的事情", zh: "已经开始了新的事情" }, type: "transformer" },
    ],
  },
  {
    id: 8,
    ...
    options: [
      { text: { ko: "이별은 언제나 아프고 격렬한 경험이다", en: "Breakups are always painful and intense", ja: "別れはいつも痛くて激しい経験だ", fr: "Les ruptures sont toujours douloureuses et intenses", es: "Las rupturas siempre son dolorosas e intensas", cn: "分手永远是痛苦而激烈的体验", zh: "分手永远是痛苦而激烈的体验" }, type: "stormy" },
      { text: { ko: "이별은 성장의 기회다", en: "Breakups are opportunities for growth", ja: "別れは成長の機会だ", fr: "Les ruptures sont des opportunités de croissance", es: "Las rupturas son oportunidades de crecimiento", cn: "分手是成长的机会", zh: "分手是成长的机会" }, type: "growth" },
      { text: { ko: "이별 후엔 혼자 시간이 필요하다", en: "I need alone time after a breakup", ja: "別れた後は一人の時間が必要だ", fr: "J'ai besoin de temps seul(e) après une rupture", es: "Necesito tiempo solo/a después de una ruptura", cn: "分手后需要独处时间", zh: "分手后需要独处时间" }, type: "solitary" },
      { text: { ko: "이별은 새로운 시작의 신호다", en: "A breakup is a signal for a new beginning", ja: "別れは新しい始まりのサインだ", fr: "Une rupture est un signal pour un nouveau départ", es: "Una ruptura es una señal para un nuevo comienzo", cn: "分手是新开始的信号", zh: "分手是新开始的信号" }, type: "transformer" },
    ],
  },
  {
    id: 9,
    ...
    options: [
      { text: { ko: "음악을 크게 틀거나 감정적인 영화를 본다", en: "Blast music or watch emotional movies", ja: "音楽を大きくかけたり感情的な映画を見る", fr: "Mettre de la musique fort ou regarder des films émouvants", es: "Poner música a todo volumen o ver películas emotivas", cn: "大声放音乐或看感人的电影", zh: "大声放音乐或看感人的电影" }, type: "stormy" },
      { text: { ko: "생각을 정리하며 메모를 한다", en: "Organize my thoughts and take notes", ja: "考えを整理しながらメモをとる", fr: "Organiser mes pensées et prendre des notes", es: "Organizar mis pensamientos y tomar notas", cn: "整理思绪并做笔记", zh: "整理思绪并做笔记" }, type: "growth" },
      { text: { ko: "그냥 조용히 천장을 바라본다", en: "Just stare at the ceiling quietly", ja: "ただ静かに天井を見つめる", fr: "Fixer le plafond tranquillement", es: "Solo mirar el techo en silencio", cn: "静静地盯着天花板", zh: "静静地盯著天花板" }, type: "solitary" },
      { text: { ko: "내일 할 계획이나 목표를 세운다", en: "Plan tomorrow's goals or activities", ja: "明日の計画や目標を立てる", fr: "Planifier les objectifs ou activités de demain", es: "Planificar las metas o actividades de mañana", cn: "制定明天的计划或目标", zh: "制定明天的计划或目标" }, type: "transformer" },
    ],
  },
  {
    id: 10,
    ...
    options: [
      { text: { ko: "감정이 정화되어 가벼워진 상태", en: "Emotionally purged and lighter", ja: "感情が浄化されて軽くなった状態", fr: "Émotionnellement purgé(e) et plus léger(ère)", es: "Emocionalmente purificado/a y más ligero/a", cn: "情绪得到净化，轻松自在", zh: "情绪得到净化，轻松自在" }, type: "stormy" },
      { text: { ko: "더 나은 나로 성장해있는 상태", en: "Grown into a better version of myself", ja: "より良い自分に成長している状態", fr: "Évolué(e) vers une meilleure version de moi-même", es: "Habiendo crecido hacia una mejor versión de mí", cn: "成长为更好的自己", zh: "成长为更好的自己" }, type: "growth" },
      { text: { ko: "평온하고 안정된 내면의 상태", en: "At peace with a stable inner state", ja: "穏やかで安定した内面の状態", fr: "Serein(e) avec un état intérieur stable", es: "En paz con un estado interior estable", cn: "内心平静安定", zh: "内心平静安定" }, type: "solitary" },
  ...
  },
  {
    ...
    options: [
      ...
      { text: { ko: "통찰력 있는 조언을 해주는 사람", en: "Someone who gives insightful advice", ja: "洞察力のあるアドバイスをしてくれる人", fr: "Quelqu'un qui donne des conseils avisés", es: "Alguien que da consejos perspicaces", cn: "给你深刻建议的人", zh: "给你深刻建议的人" }, type: "growth" },
      { text: { ko: "조용히 곁에 있어주는 사람", en: "Someone who quietly stays by your side", ja: "静かにそばにいてくれる人", fr: "Quelqu'un qui reste tranquillement à vos côtés", es: "Alguien que se queda tranquilamente a tu lado", cn: "静静陪伴在你身边的人", zh: "静静陪伴在你身边的人" }, type: "solitary" },
      { text: { ko: "새로운 경험을 함께 해주는 사람", en: "Someone who shares new experiences with you", ja: "新しい経験を一緒にしてくれる人", fr: "Quelqu'un qui partage de nouvelles expériences avec vous", es: "Alguien que comparte nuevas experiencias contigo", cn: "与你共享新体验的人", zh: "与你共享新体验的人" }, type: "transformer" },
    ],
  },
  {
    id: 12,
    ...
    options: [
      { text: { ko: "감정 해소 & 빠른 회복", en: "Emotional release & fast recovery", ja: "感情解放 & 早期回復", fr: "Libération émotionnelle & rétablissement rapide", es: "Liberación emocional & recuperación rápida", cn: "情绪释放 & 快速恢复", zh: "情绪释放 & 快速恢复" }, type: "stormy" },
      { text: { ko: "성찰 & 자기 성장", en: "Reflection & self-growth", ja: "内省 & 自己成長", fr: "Réflexion & croissance personnelle", es: "Reflexión & crecimiento personal", cn: "反思 & 自我成长", zh: "反思 & 自我成长" }, type: "growth" },
      { text: { ko: "고독 & 내면 치유", en: "Solitude & inner healing", ja: "孤独 & 内なる癒し", fr: "Solitude & guérison intérieure", es: "Soledad & sanación interior", cn: "独处 & 内在疗愈", zh: "独处 & 内在疗愈" }, type: "solitary" },
      { text: { ko: "전환 & 새로운 시작", en: "Transformation & new beginnings", ja: "転換 & 新たな始まり", fr: "Transformation & nouveaux départs", es: "Transformación & nuevos comienzos", cn: "转变 & 新的开始", zh: "转变 & 新的开始" }, type: "transformer" },
    ],
  },
];
...
const RESULTS: Record<RecoveryType, TypeResult> = {
  stormy: {
    ...
    description: {
      ...
      zh: "你是一个强烈感受和表达情绪的类型。分手后情绪波涛汹涌，但一旦充分处理，恢复也很快。与其压抑情绪，充分感受和表达才是你的疗愈方式。身边人的共情和支持对你是巨大的力量。",
    },
    tips: {
