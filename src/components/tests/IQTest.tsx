...
export const QUESTIONS: Question[] = [
  // 1 – number sequence
  {
    ...
    explanation: {
      ...
      cn: "每個數字是前一個的2倍（×2規律）。16 × 2 = 32。",
      zh: "每个数字是前一个的2倍（×2规律）。16 × 2 = 32。",
    },
    points: 6,
  },
  // 2 – number sequence (Fibonacci-like)
  {
    ...
    explanation: {
      ...
      cn: "費波那契數列：每個數是前兩個數之和。5 + 8 = 13。",
      zh: "斐波那契数列：每个数是前两个数之和。5 + 8 = 13。",
    },
    points: 7,
  },
  // 3 – number sequence (arithmetic)
  {
    ...
    explanation: {
      ...
      cn: "每步+4的等差數列。15 + 4 = 19。",
      zh: "每步+4的等差数列。15 + 4 = 19。",
    },
    points: 5,
  },
  // 4 – logic (odd one out, shape category)
  {
    ...
    explanation: {
      ...
      cn: "🔷是四邊形（菱形），其餘都是三角形或圓形。",
      zh: "🔷是四边形（菱形），其余都是三角形或圆形。",
    },
    points: 6,
  },
  // 5 – logic syllogism
  {
    ...
    optionLabels: {
      ...
      cn: ["企鵝能飛（根據前提的邏輯結論）", "企鵝不能飛", "部分鳥不能飛", "鳥是動物"],
      zh: ["企鹅能飞（根据前提的逻辑结论）", "企鹅不能飞", "部分鸟不能飞", "鸟是动物"],
    },
    options: ["A", "B", "C", "D"],
    answer: 0,
    explanation: {
      ...
      cn: "如果前提為真，三段論的邏輯結論是「企鵝能飛」。實際上是錯的，但邏輯題考驗推理的有效性而非現實真相。",
      zh: "如果前提为真，三段论的逻辑结论是「企鹅能飞」。实际上是错的，但逻辑题考验推理的有效性而非现实真相。",
    },
    points: 8,
  },
  // 6 – logic (missing number in grid)
  {
    ...
    explanation: {
      ...
      cn: "每行遵循×1、×2、×3規律。5 × 3 = 15。",
      zh: "每行遵循×1、×2、×3规律。5 × 3 = 15。",
    },
    points: 8,
  },
  // 7 – spatial (mirror)
  ...
  // 8 – logic (analogy)
  {
    ...
    prompt: {
      ...
      cn: "完成類比：月亮（亮）→ 月亮（暗）/ 太陽（白天）→ ?",
      zh: "完成类比：月亮（亮）→ 月亮（暗）/ 太阳（白天）→ ?",
    },
    options: ["🌙", "⭐", "🌃", "🌑"],
    answer: 0,
    explanation: {
      ...
      cn: "🌕→🌑是「亮→暗」轉換。☀️（白天）的對應是🌙（夜晚/月光）。",
      zh: "🌕→🌑是「亮→暗」转换。☀️（白天）的对应是🌙（夜晚/月光）。",
    },
    points: 7,
  },
  // 9 – number sequence (squares)
  {
    ...
    explanation: {
      ...
      cn: "完全平方數：1²、2²、3²、4²、5²、6²。6² = 36。",
      zh: "完全平方数：1²、2²、3²、4²、5²、6²。6² = 36。",
    },
    points: 7,
  },
  // 10 – logic (deduction)
  {
    ...
    optionLabels: {
      ...
      cn: ["A > C", "A = C", "C > A", "無法得出結論"],
      zh: ["A > C", "A = C", "C > A", "无法得出结论"],
    },
    options: ["A", "B", "C", "D"],
    answer: 0,
    explanation: {
      ...
      cn: "傳遞性：若A > B且B > C，則A > C。",
      zh: "传递性：若A > B且B > C，则A > C。",
    },
    points: 6,
  },
  ...
  // 12 – spatial rotation
  {
    ...
    prompt: {
      ...
      cn: "在↑→↓←模式中（每步順時針旋轉90°），←後是？",
      zh: "在↑→↓←模式中（每步顺时针旋转90°），←后是？",
    },
    options: ["↑", "→", "↓", "←"],
    answer: 0,
    explanation: {
  ...
  // 14 – verbal/logic (odd one out)
  {
    ...
    explanation: {
      ...
      cn: "蘋果、香蕉、葡萄是水果；胡蘿蔔是蔬菜。",
      zh: "苹果、香蕉、葡萄是水果；胡萝卜是蔬菜。",
    },
    points: 5,
  },
  // 15 – logic (probability intuition)
  {
    ...
    prompt: {
      ...
      cn: "擲兩顆公平骰子時，總和為7是最可能的結果嗎？",
      zh: "掷两颗公平骰子时，总和为7是最可能的结果吗？",
    },
    optionLabels: {
      ...
      cn: ["是的 — 7有6種組合，多於任何其他總和", "否 — 6或8更可能", "否 — 所有總和的概率相同", "否 — 12最可能"],
      zh: ["是的 — 7有6种组合，多于任何其他总和", "否 — 6或8更可能", "否 — 所有总和的概率相同", "否 — 12最可能"],
    },
    options: ["A", "B", "C", "D"],
    answer: 0,
    explanation: {
      ...
      cn: "總和為7的組合：(1,6)(2,5)(3,4)(4,3)(5,2)(6,1) = 6種。多於任何其他總和，所以7最可能。",
      zh: "总和为7的组合：(1,6)(2,5)(3,4)(4,3)(5,2)(6,1) = 6种。多于任何其他总和，所以7最可能。",
    },
    points: 8,
  },
];
