  ...
  return (
    <section className="mx-auto mt-8 max-w-6xl rounded-2xl border border-green-200 bg-green-50/40 p-4 sm:p-6" aria-labelledby="profile-export-v2-title">
      ...
      <div className="mt-3 flex flex-wrap gap-2">
        ...
        <button type="button" onClick={() => deliver(true)} disabled={!data} className="inline-flex min-h-11 items-center gap-2 rounded-lg bg-primary px-4 py-2 text-sm font-bold text-primary-foreground disabled:opacity-50"><Download className="h-4 w-4" aria-hidden="true" />{t.save}</button>
      </div>
