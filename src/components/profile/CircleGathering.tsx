...
const LENS: Record<Lang, Record<CompatibilityLensId, string>> = {
  ko: { "five-elements": "오행", "yin-yang": "음양", "chinese-zodiac": "띠", "sun-sign": "태양궁", "element-complement": "채움", "day-master": "일간", "branch-harmony": "지지 합·충" },
  en: { "five-elements": "Five elements", "yin-yang": "Yin–yang", "chinese-zodiac": "Zodiac", "sun-sign": "Sun sign", "element-complement": "Filling in", "day-master": "Day master", "branch-harmony": "Branch harmony" },
  ja: { "five-elements": "五行", "yin-yang": "陰陽", "chinese-zodiac": "干支", "sun-sign": "太陽星座", "element-complement": "補い", "day-master": "日干", "branch-harmony": "地支の合冲" },
  zh: { "five-elements": "五行", "yin-yang": "阴阳", "chinese-zodiac": "生肖", "sun-sign": "太阳星座", "element-complement": "互补", "day-master": "日干", "branch-harmony": "地支合冲" },
  fr: { "five-elements": "Cinq éléments", "yin-yang": "Yin–yang", "chinese-zodiac": "Zodiaque", "sun-sign": "Signe", "element-complement": "Complément", "day-master": "Maître du jour", "branch-harmony": "Branches" },
  es: { "five-elements": "Cinco elementos", "yin-yang": "Yin–yang", "chinese-zodiac": "Zodiaco", "sun-sign": "Signo", "element-complement": "Complemento", "day-master": "Tronco del día", "branch-harmony": "Ramas" },
};
