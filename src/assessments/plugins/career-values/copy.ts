...
type CareerValuesCopy = {
  ...
  scaleLabels: string[]; previous: string; restart: string; share: string; copied: string; shareFailed: string;
...
export const CAREER_VALUES_COPY: Record<AssessmentLocale, CareerValuesCopy> = {
  ko: {
    ...
    previous: "이전 문항", restart: "다시 하기", share: "결과 공유", copied: "결과가 복사되었습니다.", shareFailed: "공유하지 못했습니다.",
  ...
  en: {
    ...
    previous: "Previous question", restart: "Retake", share: "Share result", copied: "Result copied.", shareFailed: "Could not share.",
  ...
  zh: {
    ...
    scaleLabels: ["完全不重要", "不太重要", "一般", "比较重要", "非常重要"], previous: "上一题", restart: "重新测试", share: "分享结果", copied: "结果已复制。", shareFailed: "无法分享。", resultTitle: "你当前的工作价值观", topGroup: "高分价值组", profile: "六维分布", environments: "可进一步了解的工作环境特征", reflection: "回想这些价值曾被尊重的经历，并为下次工作选择写下一个要确认的问题。", disclaimer: "这是OIYO原创的18题自我反思工具，不是经验证的量表、诊断、职业适配或招聘判断，也不推荐特定职业。", tieNote: "同分项目并列显示。",
    dimensions: {
